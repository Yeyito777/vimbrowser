...
const std::vector<IpcCommandInfo> &IpcCommandList() {
  static const std::vector<IpcCommandInfo> commands = {
      ...
      {"open-background-tab", "open-background-tab <url-or-query>",
       "open url/query in a new background tab", "json"},
      {"open-context-tab", "open-context-tab <context-name> <url-or-query>",
       "open an active tab in a named persistent isolated request context",
       "json"},
      {"open-background-context-tab",
      ...
      {"upload-file-cancel", "upload-file-cancel <tabid>", "cancel an armed next-file-chooser upload", "json"},
