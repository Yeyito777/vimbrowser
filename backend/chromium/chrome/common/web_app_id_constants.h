...
// Shared web-app identifiers used by desktop Chrome code. These are not Ash
// implementation details and remain available in the Linux/macOS-only build.
#ifndef CHROME_COMMON_WEB_APP_ID_CONSTANTS_H_
#define CHROME_COMMON_WEB_APP_ID_CONSTANTS_H_
...
#endif  // CHROME_COMMON_WEB_APP_ID_CONSTANTS_H_
