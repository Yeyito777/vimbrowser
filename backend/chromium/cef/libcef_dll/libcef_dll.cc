...
#include "include/capi/cef_crash_util_capi_versions.h"
#include "include/capi/cef_file_util_capi_versions.h"
#include "include/capi/cef_i18n_util_capi_versions.h"
#include "include/capi/cef_origin_whitelist_capi_versions.h"
#include "include/capi/cef_parser_capi_versions.h"
#include "include/capi/cef_path_util_capi_versions.h"
#include "include/capi/cef_process_util_capi_versions.h"
...
NO_STACK_PROTECTOR CEF_EXPORT int cef_execute_process(const cef_main_args_t* args, struct _cef_app_0_t* application, void* windows_sandbox_info) {
...
CEF_EXPORT int cef_initialize(const cef_main_args_t* args, const struct _cef_settings_t* settings, struct _cef_app_0_t* application, void* windows_sandbox_info) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
...
CEF_EXPORT int cef_launch_process(struct _cef_command_line_0_t* command_line) {
  ...
  bool _retval = CefLaunchProcess(
      CefCommandLineCppToC_Unwrap(command_line));

  // Return type: bool
  return _retval;
}

CEF_EXPORT int cef_register_scheme_handler_factory(const cef_string_t* scheme_name, const cef_string_t* domain_name, struct _cef_scheme_handler_factory_0_t* factory) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
...
CEF_EXPORT int cef_post_task(cef_thread_id_t threadId, struct _cef_task_0_t* task) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
...
CEF_EXPORT int cef_post_delayed_task(cef_thread_id_t threadId, struct _cef_task_0_t* task, int64_t delay_ms) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
...
CEF_EXPORT int cef_end_tracing(const cef_string_t* tracing_file, struct _cef_end_tracing_callback_0_t* callback) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
  ...
  bool _retval = CefEndTracing(
      ...
      CefEndTracingCallbackCToCpp_Wrap(callback));
...
CEF_EXPORT int cef_register_extension(const cef_string_t* extension_name, const cef_string_t* javascript_code, struct _cef_v8_handler_0_t* handler) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
