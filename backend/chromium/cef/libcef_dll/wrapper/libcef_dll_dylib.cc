...
decltype(&cef_create_temp_directory_in_directory) cef_create_temp_directory_in_directory;
...
decltype(&cef_add_cross_origin_whitelist_entry) cef_add_cross_origin_whitelist_entry;
decltype(&cef_remove_cross_origin_whitelist_entry) cef_remove_cross_origin_whitelist_entry;
...
decltype(&cef_format_url_for_security_display) cef_format_url_for_security_display;
decltype(&cef_get_mime_type) cef_get_mime_type;
decltype(&cef_get_extensions_for_mime_type) cef_get_extensions_for_mime_type;
decltype(&cef_base64_encode) cef_base64_encode;
decltype(&cef_base64_decode) cef_base64_decode;
...
decltype(&cef_register_scheme_handler_factory) cef_register_scheme_handler_factory;
decltype(&cef_clear_scheme_handler_factories) cef_clear_scheme_handler_factories;
...
decltype(&cef_request_context_get_global_context) cef_request_context_get_global_context;
decltype(&cef_request_context_create_context) cef_request_context_create_context;
decltype(&cef_request_context_cef_create_context_shared) cef_request_context_cef_create_context_shared;
...
decltype(&cef_shared_process_message_builder_create) cef_shared_process_message_builder_create;
decltype(&cef_stream_reader_create_for_file) cef_stream_reader_create_for_file;
decltype(&cef_stream_reader_create_for_data) cef_stream_reader_create_for_data;
decltype(&cef_stream_reader_create_for_handler) cef_stream_reader_create_for_handler;
decltype(&cef_stream_writer_create_for_file) cef_stream_writer_create_for_file;
decltype(&cef_stream_writer_create_for_handler) cef_stream_writer_create_for_handler;
decltype(&cef_task_runner_get_for_current_thread) cef_task_runner_get_for_current_thread;
...
decltype(&cef_v8_value_create_int) cef_v8_value_create_int;
decltype(&cef_v8_value_create_uint) cef_v8_value_create_uint;
decltype(&cef_v8_value_create_double) cef_v8_value_create_double;
decltype(&cef_v8_value_create_date) cef_v8_value_create_date;
decltype(&cef_v8_value_create_string) cef_v8_value_create_string;
decltype(&cef_v8_value_create_object) cef_v8_value_create_object;
...
decltype(&cef_display_convert_screen_point_to_pixels) cef_display_convert_screen_point_to_pixels;
decltype(&cef_display_convert_screen_point_from_pixels) cef_display_convert_screen_point_from_pixels;
decltype(&cef_display_convert_screen_rect_to_pixels) cef_display_convert_screen_rect_to_pixels;
decltype(&cef_display_convert_screen_rect_from_pixels) cef_display_convert_screen_rect_from_pixels;
...
decltype(&cef_api_version) cef_api_version;
decltype(&cef_id_for_pack_resource_name) cef_id_for_pack_resource_name;
...
decltype(&cef_get_current_platform_thread_id) cef_get_current_platform_thread_id;
decltype(&cef_get_current_platform_thread_handle) cef_get_current_platform_thread_handle;
...
INIT_ENTRY(cef_base64_encode);
INIT_ENTRY(cef_base64_decode);
...
INIT_ENTRY(cef_request_context_cef_create_context_shared);
...
INIT_ENTRY(cef_v8_value_create_int);
INIT_ENTRY(cef_v8_value_create_uint);
INIT_ENTRY(cef_v8_value_create_double);
INIT_ENTRY(cef_v8_value_create_date);
INIT_ENTRY(cef_v8_value_create_string);
INIT_ENTRY(cef_v8_value_create_object);
...
INIT_ENTRY(cef_api_version);
INIT_ENTRY(cef_id_for_pack_resource_name);
...
NO_SANITIZE("cfi-icall") int cef_execute_process(const cef_main_args_t* args, struct _cef_app_t* application, void* windows_sandbox_info) {
  return g_libcef_pointers.cef_execute_process(args, application, windows_sandbox_info);
}

NO_SANITIZE("cfi-icall") int cef_initialize(const cef_main_args_t* args, const struct _cef_settings_t* settings, struct _cef_app_t* application, void* windows_sandbox_info) {
  return g_libcef_pointers.cef_initialize(args, settings, application, windows_sandbox_info);
}
...
NO_SANITIZE("cfi-icall") void cef_set_crash_key_value(const cef_string_t* key, const cef_string_t* value) {
  g_libcef_pointers.cef_set_crash_key_value(key, value);
}

NO_SANITIZE("cfi-icall") int cef_create_directory(const cef_string_t* full_path) {
...
NO_SANITIZE("cfi-icall") int cef_create_new_temp_directory(const cef_string_t* prefix, cef_string_t* new_temp_path) {
  return g_libcef_pointers.cef_create_new_temp_directory(prefix, new_temp_path);
}

NO_SANITIZE("cfi-icall") int cef_create_temp_directory_in_directory(const cef_string_t* base_dir, const cef_string_t* prefix, cef_string_t* new_dir) {
  return g_libcef_pointers.cef_create_temp_directory_in_directory(base_dir, prefix, new_dir);
}
...
NO_SANITIZE("cfi-icall") int cef_delete_file(const cef_string_t* path, int recursive) {
  return g_libcef_pointers.cef_delete_file(path, recursive);
}

NO_SANITIZE("cfi-icall") int cef_zip_directory(const cef_string_t* src_dir, const cef_string_t* dest_file, int include_hidden_files) {
  return g_libcef_pointers.cef_zip_directory(src_dir, dest_file, include_hidden_files);
}
...
NO_SANITIZE("cfi-icall") int cef_add_cross_origin_whitelist_entry(const cef_string_t* source_origin, const cef_string_t* target_protocol, const cef_string_t* target_domain, int allow_target_subdomains) {
  return g_libcef_pointers.cef_add_cross_origin_whitelist_entry(source_origin, target_protocol, target_domain, allow_target_subdomains);
}

NO_SANITIZE("cfi-icall") int cef_remove_cross_origin_whitelist_entry(const cef_string_t* source_origin, const cef_string_t* target_protocol, const cef_string_t* target_domain, int allow_target_subdomains) {
  return g_libcef_pointers.cef_remove_cross_origin_whitelist_entry(source_origin, target_protocol, target_domain, allow_target_subdomains);
}
...
NO_SANITIZE("cfi-icall") int cef_resolve_url(const cef_string_t* base_url, const cef_string_t* relative_url, cef_string_t* resolved_url) {
  return g_libcef_pointers.cef_resolve_url(base_url, relative_url, resolved_url);
}

NO_SANITIZE("cfi-icall") int cef_parse_url(const cef_string_t* url, struct _cef_urlparts_t* parts) {
  return g_libcef_pointers.cef_parse_url(url, parts);
}

NO_SANITIZE("cfi-icall") int cef_create_url(const struct _cef_urlparts_t* parts, cef_string_t* url) {
  return g_libcef_pointers.cef_create_url(parts, url);
}

NO_SANITIZE("cfi-icall") cef_string_userfree_t cef_format_url_for_security_display(const cef_string_t* origin_url) {
  return g_libcef_pointers.cef_format_url_for_security_display(origin_url);
}

NO_SANITIZE("cfi-icall") cef_string_userfree_t cef_get_mime_type(const cef_string_t* extension) {
  return g_libcef_pointers.cef_get_mime_type(extension);
}

NO_SANITIZE("cfi-icall") void cef_get_extensions_for_mime_type(const cef_string_t* mime_type, cef_string_list_t extensions) {
  g_libcef_pointers.cef_get_extensions_for_mime_type(mime_type, extensions);
}

NO_SANITIZE("cfi-icall") cef_string_userfree_t cef_base64_encode(const void* data, size_t data_size) {
  return g_libcef_pointers.cef_base64_encode(data, data_size);
}

NO_SANITIZE("cfi-icall") struct _cef_binary_value_t* cef_base64_decode(const cef_string_t* data) {
  return g_libcef_pointers.cef_base64_decode(data);
}

NO_SANITIZE("cfi-icall") cef_string_userfree_t cef_uriencode(const cef_string_t* text, int use_plus) {
  return g_libcef_pointers.cef_uriencode(text, use_plus);
}

NO_SANITIZE("cfi-icall") cef_string_userfree_t cef_uridecode(const cef_string_t* text, int convert_to_utf8, cef_uri_unescape_rule_t unescape_rule) {
  return g_libcef_pointers.cef_uridecode(text, convert_to_utf8, unescape_rule);
}

NO_SANITIZE("cfi-icall") struct _cef_value_t* cef_parse_json(const cef_string_t* json_string, cef_json_parser_options_t options) {
  return g_libcef_pointers.cef_parse_json(json_string, options);
}

NO_SANITIZE("cfi-icall") struct _cef_value_t* cef_parse_json_buffer(const void* json, size_t json_size, cef_json_parser_options_t options) {
  return g_libcef_pointers.cef_parse_json_buffer(json, json_size, options);
}

NO_SANITIZE("cfi-icall") struct _cef_value_t* cef_parse_jsonand_return_error(const cef_string_t* json_string, cef_json_parser_options_t options, cef_string_t* error_msg_out) {
  return g_libcef_pointers.cef_parse_jsonand_return_error(json_string, options, error_msg_out);
}

NO_SANITIZE("cfi-icall") cef_string_userfree_t cef_write_json(struct _cef_value_t* node, cef_json_writer_options_t options) {
  return g_libcef_pointers.cef_write_json(node, options);
}

NO_SANITIZE("cfi-icall") int cef_get_path(cef_path_key_t key, cef_string_t* path) {
  return g_libcef_pointers.cef_get_path(key, path);
}

NO_SANITIZE("cfi-icall") int cef_launch_process(struct _cef_command_line_t* command_line) {
  return g_libcef_pointers.cef_launch_process(command_line);
}

NO_SANITIZE("cfi-icall") int cef_register_scheme_handler_factory(const cef_string_t* scheme_name, const cef_string_t* domain_name, struct _cef_scheme_handler_factory_t* factory) {
  return g_libcef_pointers.cef_register_scheme_handler_factory(scheme_name, domain_name, factory);
}
...
NO_SANITIZE("cfi-icall") int cef_is_cert_status_error(cef_cert_status_t status) {
...
NO_SANITIZE("cfi-icall") int cef_post_task(cef_thread_id_t threadId, struct _cef_task_t* task) {
  return g_libcef_pointers.cef_post_task(threadId, task);
}

NO_SANITIZE("cfi-icall") int cef_post_delayed_task(cef_thread_id_t threadId, struct _cef_task_t* task, int64_t delay_ms) {
  return g_libcef_pointers.cef_post_delayed_task(threadId, task, delay_ms);
}

NO_SANITIZE("cfi-icall") int cef_begin_tracing(const cef_string_t* categories, struct _cef_completion_callback_t* callback) {
  return g_libcef_pointers.cef_begin_tracing(categories, callback);
}

NO_SANITIZE("cfi-icall") int cef_end_tracing(const cef_string_t* tracing_file, struct _cef_end_tracing_callback_t* callback) {
...
NO_SANITIZE("cfi-icall") struct _cef_browser_t* cef_browser_host_create_browser_sync(const struct _cef_window_info_t* windowInfo, struct _cef_client_t* client, const cef_string_t* url, const struct _cef_browser_settings_t* settings, struct _cef_dictionary_value_t* extra_info, struct _cef_request_context_t* request_context) {
  return g_libcef_pointers.cef_browser_host_create_browser_sync(windowInfo, client, url, settings, extra_info, request_context);
}
...
NO_SANITIZE("cfi-icall") struct _cef_command_line_t* cef_command_line_get_global() {
...
NO_SANITIZE("cfi-icall") struct _cef_media_router_t* cef_media_router_get_global(struct _cef_completion_callback_t* callback) {
...
NO_SANITIZE("cfi-icall") struct _cef_print_settings_t* cef_print_settings_create() {
  return g_libcef_pointers.cef_print_settings_create();
}

NO_SANITIZE("cfi-icall") struct _cef_process_message_t* cef_process_message_create(const cef_string_t* name) {
...
NO_SANITIZE("cfi-icall") struct _cef_post_data_element_t* cef_post_data_element_create() {
  return g_libcef_pointers.cef_post_data_element_create();
}

NO_SANITIZE("cfi-icall") struct _cef_request_context_t* cef_request_context_get_global_context() {
  return g_libcef_pointers.cef_request_context_get_global_context();
}

NO_SANITIZE("cfi-icall") struct _cef_request_context_t* cef_request_context_create_context(const struct _cef_request_context_settings_t* settings, struct _cef_request_context_handler_t* handler) {
  return g_libcef_pointers.cef_request_context_create_context(settings, handler);
}

NO_SANITIZE("cfi-icall") struct _cef_request_context_t* cef_request_context_cef_create_context_shared(struct _cef_request_context_t* other, struct _cef_request_context_handler_t* handler) {
  return g_libcef_pointers.cef_request_context_cef_create_context_shared(other, handler);
}

NO_SANITIZE("cfi-icall") struct _cef_resource_bundle_t* cef_resource_bundle_get_global() {
...
NO_SANITIZE("cfi-icall") void cef_server_create(const cef_string_t* address, uint16_t port, int backlog, struct _cef_server_handler_t* handler) {
  g_libcef_pointers.cef_server_create(address, port, backlog, handler);
}

NO_SANITIZE("cfi-icall") struct _cef_shared_process_message_builder_t* cef_shared_process_message_builder_create(const cef_string_t* name, size_t byte_size) {
  return g_libcef_pointers.cef_shared_process_message_builder_create(name, byte_size);
}

NO_SANITIZE("cfi-icall") struct _cef_stream_reader_t* cef_stream_reader_create_for_file(const cef_string_t* fileName) {
  return g_libcef_pointers.cef_stream_reader_create_for_file(fileName);
}

NO_SANITIZE("cfi-icall") struct _cef_stream_reader_t* cef_stream_reader_create_for_data(void* data, size_t size) {
  return g_libcef_pointers.cef_stream_reader_create_for_data(data, size);
}

NO_SANITIZE("cfi-icall") struct _cef_stream_reader_t* cef_stream_reader_create_for_handler(struct _cef_read_handler_t* handler) {
  return g_libcef_pointers.cef_stream_reader_create_for_handler(handler);
}

NO_SANITIZE("cfi-icall") struct _cef_stream_writer_t* cef_stream_writer_create_for_file(const cef_string_t* fileName) {
  return g_libcef_pointers.cef_stream_writer_create_for_file(fileName);
}

NO_SANITIZE("cfi-icall") struct _cef_stream_writer_t* cef_stream_writer_create_for_handler(struct _cef_write_handler_t* handler) {
  return g_libcef_pointers.cef_stream_writer_create_for_handler(handler);
}

NO_SANITIZE("cfi-icall") struct _cef_task_runner_t* cef_task_runner_get_for_current_thread() {
  return g_libcef_pointers.cef_task_runner_get_for_current_thread();
}

NO_SANITIZE("cfi-icall") struct _cef_task_runner_t* cef_task_runner_get_for_thread(cef_thread_id_t threadId) {
...
NO_SANITIZE("cfi-icall") struct _cef_thread_t* cef_thread_create(const cef_string_t* display_name, cef_thread_priority_t priority, cef_message_loop_type_t message_loop_type, int stoppable, cef_com_init_mode_t com_init_mode) {
  return g_libcef_pointers.cef_thread_create(display_name, priority, message_loop_type, stoppable, com_init_mode);
}

NO_SANITIZE("cfi-icall") struct _cef_urlrequest_t* cef_urlrequest_create(struct _cef_request_t* request, struct _cef_urlrequest_client_t* client, struct _cef_request_context_t* request_context) {
  return g_libcef_pointers.cef_urlrequest_create(request, client, request_context);
}

NO_SANITIZE("cfi-icall") struct _cef_v8_context_t* cef_v8_context_get_current_context() {
  return g_libcef_pointers.cef_v8_context_get_current_context();
}

NO_SANITIZE("cfi-icall") struct _cef_v8_context_t* cef_v8_context_get_entered_context() {
  return g_libcef_pointers.cef_v8_context_get_entered_context();
}

NO_SANITIZE("cfi-icall") int cef_v8_context_in_context() {
...
NO_SANITIZE("cfi-icall") struct _cef_v8_value_t* cef_v8_value_create_null() {
  return g_libcef_pointers.cef_v8_value_create_null();
}

NO_SANITIZE("cfi-icall") struct _cef_v8_value_t* cef_v8_value_create_bool(int value) {
  return g_libcef_pointers.cef_v8_value_create_bool(value);
}

NO_SANITIZE("cfi-icall") struct _cef_v8_value_t* cef_v8_value_create_int(int32_t value) {
  return g_libcef_pointers.cef_v8_value_create_int(value);
}

NO_SANITIZE("cfi-icall") struct _cef_v8_value_t* cef_v8_value_create_uint(uint32_t value) {
  return g_libcef_pointers.cef_v8_value_create_uint(value);
}

NO_SANITIZE("cfi-icall") struct _cef_v8_value_t* cef_v8_value_create_double(double value) {
  return g_libcef_pointers.cef_v8_value_create_double(value);
}

NO_SANITIZE("cfi-icall") struct _cef_v8_value_t* cef_v8_value_create_date(cef_basetime_t date) {
  return g_libcef_pointers.cef_v8_value_create_date(date);
}

NO_SANITIZE("cfi-icall") struct _cef_v8_value_t* cef_v8_value_create_string(const cef_string_t* value) {
  return g_libcef_pointers.cef_v8_value_create_string(value);
}

NO_SANITIZE("cfi-icall") struct _cef_v8_value_t* cef_v8_value_create_object(struct _cef_v8_accessor_t* accessor, struct _cef_v8_interceptor_t* interceptor) {
  return g_libcef_pointers.cef_v8_value_create_object(accessor, interceptor);
}

NO_SANITIZE("cfi-icall") struct _cef_v8_value_t* cef_v8_value_create_array(int length) {
  return g_libcef_pointers.cef_v8_value_create_array(length);
}

NO_SANITIZE("cfi-icall") struct _cef_v8_value_t* cef_v8_value_create_array_buffer(void* buffer, size_t length, struct _cef_v8_array_buffer_release_callback_t* release_callback) {
  return g_libcef_pointers.cef_v8_value_create_array_buffer(buffer, length, release_callback);
}
...
NO_SANITIZE("cfi-icall") struct _cef_v8_value_t* cef_v8_value_create_promise() {
  return g_libcef_pointers.cef_v8_value_create_promise();
}

NO_SANITIZE("cfi-icall") struct _cef_v8_stack_trace_t* cef_v8_stack_trace_get_current(int frame_limit) {
  return g_libcef_pointers.cef_v8_stack_trace_get_current(frame_limit);
}
...
NO_SANITIZE("cfi-icall") struct _cef_binary_value_t* cef_binary_value_create(const void* data, size_t data_size) {
  return g_libcef_pointers.cef_binary_value_create(data, data_size);
}

NO_SANITIZE("cfi-icall") struct _cef_dictionary_value_t* cef_dictionary_value_create() {
...
NO_SANITIZE("cfi-icall") struct _cef_waitable_event_t* cef_waitable_event_create(int automatic_reset, int initially_signaled) {
  return g_libcef_pointers.cef_waitable_event_create(automatic_reset, initially_signaled);
}

NO_SANITIZE("cfi-icall") struct _cef_xml_reader_t* cef_xml_reader_create(struct _cef_stream_reader_t* stream, cef_xml_encoding_type_t encodingType, const cef_string_t* URI) {
...
NO_SANITIZE("cfi-icall") struct _cef_browser_view_t* cef_browser_view_create(struct _cef_client_t* client, const cef_string_t* url, const struct _cef_browser_settings_t* settings, struct _cef_dictionary_value_t* extra_info, struct _cef_request_context_t* request_context, struct _cef_browser_view_delegate_t* delegate) {
  return g_libcef_pointers.cef_browser_view_create(client, url, settings, extra_info, request_context, delegate);
}

NO_SANITIZE("cfi-icall") struct _cef_browser_view_t* cef_browser_view_get_for_browser(struct _cef_browser_t* browser) {
...
NO_SANITIZE("cfi-icall") struct _cef_display_t* cef_display_get_nearest_point(const cef_point_t* point, int input_pixel_coords) {
  return g_libcef_pointers.cef_display_get_nearest_point(point, input_pixel_coords);
}

NO_SANITIZE("cfi-icall") struct _cef_display_t* cef_display_get_matching_bounds(const cef_rect_t* bounds, int input_pixel_coords) {
  return g_libcef_pointers.cef_display_get_matching_bounds(bounds, input_pixel_coords);
}
...
NO_SANITIZE("cfi-icall") void cef_display_get_alls(size_t* displaysCount, struct _cef_display_t** displays) {
  g_libcef_pointers.cef_display_get_alls(displaysCount, displays);
}

NO_SANITIZE("cfi-icall") cef_point_t cef_display_convert_screen_point_to_pixels(const cef_point_t* point) {
  return g_libcef_pointers.cef_display_convert_screen_point_to_pixels(point);
}

NO_SANITIZE("cfi-icall") cef_point_t cef_display_convert_screen_point_from_pixels(const cef_point_t* point) {
  return g_libcef_pointers.cef_display_convert_screen_point_from_pixels(point);
}

NO_SANITIZE("cfi-icall") cef_rect_t cef_display_convert_screen_rect_to_pixels(const cef_rect_t* rect) {
  return g_libcef_pointers.cef_display_convert_screen_rect_to_pixels(rect);
}

NO_SANITIZE("cfi-icall") cef_rect_t cef_display_convert_screen_rect_from_pixels(const cef_rect_t* rect) {
  return g_libcef_pointers.cef_display_convert_screen_rect_from_pixels(rect);
}

NO_SANITIZE("cfi-icall") struct _cef_label_button_t* cef_label_button_create(struct _cef_button_delegate_t* delegate, const cef_string_t* text) {
  return g_libcef_pointers.cef_label_button_create(delegate, text);
}

NO_SANITIZE("cfi-icall") struct _cef_menu_button_t* cef_menu_button_create(struct _cef_menu_button_delegate_t* delegate, const cef_string_t* text) {
  return g_libcef_pointers.cef_menu_button_create(delegate, text);
}

NO_SANITIZE("cfi-icall") struct _cef_panel_t* cef_panel_create(struct _cef_panel_delegate_t* delegate) {
  return g_libcef_pointers.cef_panel_create(delegate);
}

NO_SANITIZE("cfi-icall") struct _cef_scroll_view_t* cef_scroll_view_create(struct _cef_view_delegate_t* delegate) {
  return g_libcef_pointers.cef_scroll_view_create(delegate);
}

NO_SANITIZE("cfi-icall") struct _cef_textfield_t* cef_textfield_create(struct _cef_textfield_delegate_t* delegate) {
  return g_libcef_pointers.cef_textfield_create(delegate);
}

NO_SANITIZE("cfi-icall") struct _cef_window_t* cef_window_create_top_level(struct _cef_window_delegate_t* delegate) {
  return g_libcef_pointers.cef_window_create_top_level(delegate);
}

NO_SANITIZE("cfi-icall") const char* cef_api_hash(int version, int entry) {
  return g_libcef_pointers.cef_api_hash(version, entry);
}

NO_SANITIZE("cfi-icall") int cef_api_version() {
  return g_libcef_pointers.cef_api_version();
}

NO_SANITIZE("cfi-icall") int cef_id_for_pack_resource_name(const char* name) {
  return g_libcef_pointers.cef_id_for_pack_resource_name(name);
}

NO_SANITIZE("cfi-icall") int cef_id_for_pack_string_name(const char* name) {
  return g_libcef_pointers.cef_id_for_pack_string_name(name);
}

NO_SANITIZE("cfi-icall") int cef_id_for_command_id_name(const char* name) {
  return g_libcef_pointers.cef_id_for_command_id_name(name);
}
...
NO_SANITIZE("cfi-icall") int cef_dump_without_crashing(long long mseconds_between_dumps, const char* function_name, const char* file_name, int line_number) {
  return g_libcef_pointers.cef_dump_without_crashing(mseconds_between_dumps, function_name, file_name, line_number);
}
...
NO_SANITIZE("cfi-icall") int cef_get_vlog_level(const char* file_start, size_t N) {
  return g_libcef_pointers.cef_get_vlog_level(file_start, N);
}

NO_SANITIZE("cfi-icall") void cef_log(const char* file, int line, int severity, const char* message) {
...
NO_SANITIZE("cfi-icall") int cef_string_list_value(cef_string_list_t list, size_t index, cef_string_t* value) {
  return g_libcef_pointers.cef_string_list_value(list, index, value);
}

NO_SANITIZE("cfi-icall") void cef_string_list_append(cef_string_list_t list, const cef_string_t* value) {
...
NO_SANITIZE("cfi-icall") cef_string_list_t cef_string_list_copy(cef_string_list_t list) {
...
NO_SANITIZE("cfi-icall") int cef_string_map_find(cef_string_map_t map, const cef_string_t* key, cef_string_t* value) {
  return g_libcef_pointers.cef_string_map_find(map, key, value);
}

NO_SANITIZE("cfi-icall") int cef_string_map_key(cef_string_map_t map, size_t index, cef_string_t* key) {
  return g_libcef_pointers.cef_string_map_key(map, index, key);
}

NO_SANITIZE("cfi-icall") int cef_string_map_value(cef_string_map_t map, size_t index, cef_string_t* value) {
  return g_libcef_pointers.cef_string_map_value(map, index, value);
}

NO_SANITIZE("cfi-icall") int cef_string_map_append(cef_string_map_t map, const cef_string_t* key, const cef_string_t* value) {
...
NO_SANITIZE("cfi-icall") size_t cef_string_multimap_size(cef_string_multimap_t map) {
  return g_libcef_pointers.cef_string_multimap_size(map);
}

NO_SANITIZE("cfi-icall") size_t cef_string_multimap_find_count(cef_string_multimap_t map, const cef_string_t* key) {
  return g_libcef_pointers.cef_string_multimap_find_count(map, key);
}

NO_SANITIZE("cfi-icall") int cef_string_multimap_enumerate(cef_string_multimap_t map, const cef_string_t* key, size_t value_index, cef_string_t* value) {
  return g_libcef_pointers.cef_string_multimap_enumerate(map, key, value_index, value);
}

NO_SANITIZE("cfi-icall") int cef_string_multimap_key(cef_string_multimap_t map, size_t index, cef_string_t* key) {
  return g_libcef_pointers.cef_string_multimap_key(map, index, key);
}

NO_SANITIZE("cfi-icall") int cef_string_multimap_value(cef_string_multimap_t map, size_t index, cef_string_t* value) {
  return g_libcef_pointers.cef_string_multimap_value(map, index, value);
}

NO_SANITIZE("cfi-icall") int cef_string_multimap_append(cef_string_multimap_t map, const cef_string_t* key, const cef_string_t* value) {
  return g_libcef_pointers.cef_string_multimap_append(map, key, value);
}

NO_SANITIZE("cfi-icall") void cef_string_multimap_clear(cef_string_multimap_t map) {
  g_libcef_pointers.cef_string_multimap_clear(map);
}

NO_SANITIZE("cfi-icall") void cef_string_multimap_free(cef_string_multimap_t map) {
  g_libcef_pointers.cef_string_multimap_free(map);
}

NO_SANITIZE("cfi-icall") int cef_string_wide_set(const wchar_t* src, size_t src_len, cef_string_wide_t* output, int copy) {
  return g_libcef_pointers.cef_string_wide_set(src, src_len, output, copy);
}

NO_SANITIZE("cfi-icall") int cef_string_utf8_set(const char* src, size_t src_len, cef_string_utf8_t* output, int copy) {
  return g_libcef_pointers.cef_string_utf8_set(src, src_len, output, copy);
}

NO_SANITIZE("cfi-icall") int cef_string_utf16_set(const char16_t* src, size_t src_len, cef_string_utf16_t* output, int copy) {
...
NO_SANITIZE("cfi-icall") int cef_string_wide_cmp(const cef_string_wide_t* str1, const cef_string_wide_t* str2) {
  return g_libcef_pointers.cef_string_wide_cmp(str1, str2);
}

NO_SANITIZE("cfi-icall") int cef_string_utf8_cmp(const cef_string_utf8_t* str1, const cef_string_utf8_t* str2) {
  return g_libcef_pointers.cef_string_utf8_cmp(str1, str2);
}

NO_SANITIZE("cfi-icall") int cef_string_utf16_cmp(const cef_string_utf16_t* str1, const cef_string_utf16_t* str2) {
  return g_libcef_pointers.cef_string_utf16_cmp(str1, str2);
}

NO_SANITIZE("cfi-icall") int cef_string_wide_to_utf8(const wchar_t* src, size_t src_len, cef_string_utf8_t* output) {
  return g_libcef_pointers.cef_string_wide_to_utf8(src, src_len, output);
}

NO_SANITIZE("cfi-icall") int cef_string_utf8_to_wide(const char* src, size_t src_len, cef_string_wide_t* output) {
  return g_libcef_pointers.cef_string_utf8_to_wide(src, src_len, output);
}

NO_SANITIZE("cfi-icall") int cef_string_wide_to_utf16(const wchar_t* src, size_t src_len, cef_string_utf16_t* output) {
  return g_libcef_pointers.cef_string_wide_to_utf16(src, src_len, output);
}

NO_SANITIZE("cfi-icall") int cef_string_utf16_to_wide(const char16_t* src, size_t src_len, cef_string_wide_t* output) {
  return g_libcef_pointers.cef_string_utf16_to_wide(src, src_len, output);
}

NO_SANITIZE("cfi-icall") int cef_string_utf8_to_utf16(const char* src, size_t src_len, cef_string_utf16_t* output) {
  return g_libcef_pointers.cef_string_utf8_to_utf16(src, src_len, output);
}

NO_SANITIZE("cfi-icall") int cef_string_utf16_to_utf8(const char16_t* src, size_t src_len, cef_string_utf8_t* output) {
  return g_libcef_pointers.cef_string_utf16_to_utf8(src, src_len, output);
}

NO_SANITIZE("cfi-icall") int cef_string_ascii_to_wide(const char* src, size_t src_len, cef_string_wide_t* output) {
  return g_libcef_pointers.cef_string_ascii_to_wide(src, src_len, output);
}

NO_SANITIZE("cfi-icall") int cef_string_ascii_to_utf16(const char* src, size_t src_len, cef_string_utf16_t* output) {
  return g_libcef_pointers.cef_string_ascii_to_utf16(src, src_len, output);
}

NO_SANITIZE("cfi-icall") cef_string_userfree_wide_t cef_string_userfree_wide_alloc() {
  return g_libcef_pointers.cef_string_userfree_wide_alloc();
}

NO_SANITIZE("cfi-icall") cef_string_userfree_utf8_t cef_string_userfree_utf8_alloc() {
  return g_libcef_pointers.cef_string_userfree_utf8_alloc();
}

NO_SANITIZE("cfi-icall") cef_string_userfree_utf16_t cef_string_userfree_utf16_alloc() {
  return g_libcef_pointers.cef_string_userfree_utf16_alloc();
}

NO_SANITIZE("cfi-icall") void cef_string_userfree_wide_free(cef_string_userfree_wide_t str) {
  g_libcef_pointers.cef_string_userfree_wide_free(str);
}

NO_SANITIZE("cfi-icall") void cef_string_userfree_utf8_free(cef_string_userfree_utf8_t str) {
  g_libcef_pointers.cef_string_userfree_utf8_free(str);
}

NO_SANITIZE("cfi-icall") void cef_string_userfree_utf16_free(cef_string_userfree_utf16_t str) {
  g_libcef_pointers.cef_string_userfree_utf16_free(str);
}

NO_SANITIZE("cfi-icall") int cef_string_utf16_to_lower(const char16_t* src, size_t src_len, cef_string_utf16_t* output) {
  return g_libcef_pointers.cef_string_utf16_to_lower(src, src_len, output);
}

NO_SANITIZE("cfi-icall") int cef_string_utf16_to_upper(const char16_t* src, size_t src_len, cef_string_utf16_t* output) {
  return g_libcef_pointers.cef_string_utf16_to_upper(src, src_len, output);
}

NO_SANITIZE("cfi-icall") cef_platform_thread_id_t cef_get_current_platform_thread_id() {
  return g_libcef_pointers.cef_get_current_platform_thread_id();
}

NO_SANITIZE("cfi-icall") cef_platform_thread_handle_t cef_get_current_platform_thread_handle() {
...
NO_SANITIZE("cfi-icall") int cef_time_from_timet(time_t time, cef_time_t* cef_time) {
  return g_libcef_pointers.cef_time_from_timet(time, cef_time);
}

NO_SANITIZE("cfi-icall") int cef_time_to_doublet(const cef_time_t* cef_time, double* time) {
  return g_libcef_pointers.cef_time_to_doublet(cef_time, time);
}

NO_SANITIZE("cfi-icall") int cef_time_from_doublet(double time, cef_time_t* cef_time) {
...
NO_SANITIZE("cfi-icall") int cef_time_delta(const cef_time_t* cef_time1, const cef_time_t* cef_time2, long long* delta) {
  return g_libcef_pointers.cef_time_delta(cef_time1, cef_time2, delta);
}

NO_SANITIZE("cfi-icall") int cef_time_to_basetime(const cef_time_t* from, cef_basetime_t* to) {
  return g_libcef_pointers.cef_time_to_basetime(from, to);
}

NO_SANITIZE("cfi-icall") int cef_time_from_basetime(const cef_basetime_t from, cef_time_t* to) {
  return g_libcef_pointers.cef_time_from_basetime(from, to);
}

NO_SANITIZE("cfi-icall") void cef_trace_event_instant(const char* category, const char* name, const char* arg1_name, uint64_t arg1_val, const char* arg2_name, uint64_t arg2_val) {
  g_libcef_pointers.cef_trace_event_instant(category, name, arg1_name, arg1_val, arg2_name, arg2_val);
}

NO_SANITIZE("cfi-icall") void cef_trace_event_begin(const char* category, const char* name, const char* arg1_name, uint64_t arg1_val, const char* arg2_name, uint64_t arg2_val) {
  g_libcef_pointers.cef_trace_event_begin(category, name, arg1_name, arg1_val, arg2_name, arg2_val);
}

NO_SANITIZE("cfi-icall") void cef_trace_event_end(const char* category, const char* name, const char* arg1_name, uint64_t arg1_val, const char* arg2_name, uint64_t arg2_val) {
  g_libcef_pointers.cef_trace_event_end(category, name, arg1_name, arg1_val, arg2_name, arg2_val);
}

NO_SANITIZE("cfi-icall") void cef_trace_counter(const char* category, const char* name, const char* value1_name, uint64_t value1_val, const char* value2_name, uint64_t value2_val) {
  g_libcef_pointers.cef_trace_counter(category, name, value1_name, value1_val, value2_name, value2_val);
}

NO_SANITIZE("cfi-icall") void cef_trace_counter_id(const char* category, const char* name, uint64_t id, const char* value1_name, uint64_t value1_val, const char* value2_name, uint64_t value2_val) {
  g_libcef_pointers.cef_trace_counter_id(category, name, id, value1_name, value1_val, value2_name, value2_val);
}

NO_SANITIZE("cfi-icall") void cef_trace_event_async_begin(const char* category, const char* name, uint64_t id, const char* arg1_name, uint64_t arg1_val, const char* arg2_name, uint64_t arg2_val) {
  g_libcef_pointers.cef_trace_event_async_begin(category, name, id, arg1_name, arg1_val, arg2_name, arg2_val);
}

NO_SANITIZE("cfi-icall") void cef_trace_event_async_step_into(const char* category, const char* name, uint64_t id, uint64_t step, const char* arg1_name, uint64_t arg1_val) {
  g_libcef_pointers.cef_trace_event_async_step_into(category, name, id, step, arg1_name, arg1_val);
}

NO_SANITIZE("cfi-icall") void cef_trace_event_async_step_past(const char* category, const char* name, uint64_t id, uint64_t step, const char* arg1_name, uint64_t arg1_val) {
  g_libcef_pointers.cef_trace_event_async_step_past(category, name, id, step, arg1_name, arg1_val);
}
