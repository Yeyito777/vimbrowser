...
std::vector<TextCharPos> CPDF_Font::GetCharPosList(
  ...
  CPDF_CIDFont* cid_font = AsCIDFont();
  bool is_vertical_writing = cid_font && cid_font->IsVertWriting();
  bool has_to_unicode = !!GetFontDict()->GetStreamFor("ToUnicode");
