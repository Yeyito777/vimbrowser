...
class GpuCounterDescriptor(_message.Message):
    ...
    def __init__(self, specs: _Optional[_Iterable[_Union[GpuCounterDescriptor.GpuCounterSpec, _Mapping]]] = ..., blocks: _Optional[_Iterable[_Union[GpuCounterDescriptor.GpuCounterBlock, _Mapping]]] = ..., min_sampling_period_ns: _Optional[int] = ..., max_sampling_period_ns: _Optional[int] = ..., supports_instrumented_sampling: _Optional[bool] = ...) -> None: ...
...
class DataSourceDescriptor(_message.Message):
    ...
    no_flush: bool
    protovm_program: VmProgram
    gpu_counter_descriptor: GpuCounterDescriptor
    track_event_descriptor: TrackEventDescriptor
    ftrace_descriptor: FtraceDescriptor
    def __init__(self, name: _Optional[str] = ..., id: _Optional[int] = ..., will_notify_on_stop: _Optional[bool] = ..., will_notify_on_start: _Optional[bool] = ..., handles_incremental_state_clear: _Optional[bool] = ..., no_flush: _Optional[bool] = ..., protovm_program: _Optional[_Union[VmProgram, _Mapping]] = ..., gpu_counter_descriptor: _Optional[_Union[GpuCounterDescriptor, _Mapping]] = ..., track_event_descriptor: _Optional[_Union[TrackEventDescriptor, _Mapping]] = ..., ftrace_descriptor: _Optional[_Union[FtraceDescriptor, _Mapping]] = ...) -> None: ...
...
class TraceConfig(_message.Message):
    ...
    class BuiltinDataSource(_message.Message):
        ...
        def __init__(self, disable_clock_snapshotting: _Optional[bool] = ..., disable_trace_config: _Optional[bool] = ..., disable_system_info: _Optional[bool] = ..., disable_service_events: _Optional[bool] = ..., primary_trace_clock: _Optional[_Union[BuiltinClock, str]] = ..., snapshot_interval_ms: _Optional[int] = ..., prefer_suspend_clock_for_snapshot: _Optional[bool] = ..., disable_chunk_usage_histograms: _Optional[bool] = ...) -> None: ...
...
class TraceStats(_message.Message):
    ...
    class FilterStats(_message.Message):
        __slots__ = ("input_packets", "input_bytes", "output_bytes", "errors", "time_taken_ns", "bytes_discarded_per_buffer")
...
class ChromeBenchmarkMetadata(_message.Message):
    ...
    story_run_index: int
    had_failures: bool
    def __init__(self, benchmark_start_time_us: _Optional[int] = ..., story_run_time_us: _Optional[int] = ..., benchmark_name: _Optional[str] = ..., benchmark_description: _Optional[str] = ..., label: _Optional[str] = ..., story_name: _Optional[str] = ..., story_tags: _Optional[_Iterable[str]] = ..., story_run_index: _Optional[int] = ..., had_failures: _Optional[bool] = ...) -> None: ...

class ChromeMetadataPacket(_message.Message):
    __slots__ = ("background_tracing_metadata", "chrome_version_code", "enabled_categories", "field_trial_hashes", "app_package_name")
    ...
    APP_PACKAGE_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, background_tracing_metadata: _Optional[_Union[BackgroundTracingMetadata, _Mapping]] = ..., chrome_version_code: _Optional[int] = ..., enabled_categories: _Optional[str] = ..., field_trial_hashes: _Optional[_Iterable[_Union[ChromeMetadataPacket.FinchHash, _Mapping]]] = ..., app_package_name: _Optional[str] = ...) -> None: ...
...
class ChromeTraceEvent(_message.Message):
    ...
    class Arg(_message.Message):
        ...
        name_index: int
        def __init__(self, name: _Optional[str] = ..., bool_value: _Optional[bool] = ..., uint_value: _Optional[int] = ..., int_value: _Optional[int] = ..., double_value: _Optional[float] = ..., string_value: _Optional[str] = ..., pointer_value: _Optional[int] = ..., json_value: _Optional[str] = ..., traced_value: _Optional[_Union[ChromeTracedValue, _Mapping]] = ..., name_index: _Optional[int] = ...) -> None: ...
    NAME_FIELD_NUMBER: _ClassVar[int]
...
class ChromeMetadata(_message.Message):
    ...
    int_value: int
    json_value: str
    def __init__(self, name: _Optional[str] = ..., string_value: _Optional[str] = ..., bool_value: _Optional[bool] = ..., int_value: _Optional[int] = ..., json_value: _Optional[str] = ...) -> None: ...
...
class ChromeTrigger(_message.Message):
    __slots__ = ("trigger_name", "trigger_name_hash", "flow_id")
...
class InternedV8JsFunction(_message.Message):
    __slots__ = ("iid", "v8_js_function_name_iid", "v8_js_script_iid", "is_toplevel", "kind", "byte_offset", "line", "column")
    ...
    line: int
    column: int
    def __init__(self, iid: _Optional[int] = ..., v8_js_function_name_iid: _Optional[int] = ..., v8_js_script_iid: _Optional[int] = ..., is_toplevel: _Optional[bool] = ..., kind: _Optional[_Union[InternedV8JsFunction.Kind, str]] = ..., byte_offset: _Optional[int] = ..., line: _Optional[int] = ..., column: _Optional[int] = ...) -> None: ...

class InternedV8Isolate(_message.Message):
    __slots__ = ("iid", "pid", "isolate_id", "code_range", "embedded_blob_code_start_address", "embedded_blob_code_size")
    class CodeRange(_message.Message):
        ...
        def __init__(self, base_address: _Optional[int] = ..., size: _Optional[int] = ..., embedded_blob_code_copy_start_address: _Optional[int] = ..., is_process_wide: _Optional[bool] = ...) -> None: ...
    IID_FIELD_NUMBER: _ClassVar[int]
    PID_FIELD_NUMBER: _ClassVar[int]
...
class V8JsCode(_message.Message):
    __slots__ = ("v8_isolate_iid", "tid", "v8_js_function_iid", "tier", "instruction_start", "instruction_size_bytes", "machine_code", "bytecode", "source_positions", "bytecode_positions", "inlined_bytecode_positions")
    ...
    BYTECODE_FIELD_NUMBER: _ClassVar[int]
    SOURCE_POSITIONS_FIELD_NUMBER: _ClassVar[int]
    BYTECODE_POSITIONS_FIELD_NUMBER: _ClassVar[int]
    INLINED_BYTECODE_POSITIONS_FIELD_NUMBER: _ClassVar[int]
    v8_isolate_iid: int
    tid: int
    ...
    machine_code: bytes
    bytecode: bytes
    source_positions: bytes
    bytecode_positions: bytes
    inlined_bytecode_positions: bytes
    def __init__(self, v8_isolate_iid: _Optional[int] = ..., tid: _Optional[int] = ..., v8_js_function_iid: _Optional[int] = ..., tier: _Optional[_Union[V8JsCode.Tier, str]] = ..., instruction_start: _Optional[int] = ..., instruction_size_bytes: _Optional[int] = ..., machine_code: _Optional[bytes] = ..., bytecode: _Optional[bytes] = ..., source_positions: _Optional[bytes] = ..., bytecode_positions: _Optional[bytes] = ..., inlined_bytecode_positions: _Optional[bytes] = ...) -> None: ...

class V8InternalCode(_message.Message):
    __slots__ = ("v8_isolate_iid", "tid", "name", "type", "builtin_id", "instruction_start", "instruction_size_bytes", "machine_code")
    class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
...
class V8WasmCode(_message.Message):
    __slots__ = ("v8_isolate_iid", "tid", "v8_wasm_script_iid", "function_name", "tier", "code_offset_in_module", "instruction_start", "instruction_size_bytes", "machine_code")
    class Tier(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
...
class V8CodeMove(_message.Message):
    __slots__ = ("isolate_iid", "tid", "from_instruction_start_address", "to_instruction_start_address", "instruction_size_bytes", "to_machine_code", "to_bytecode")
...
class ClockSnapshot(_message.Message):
    ...
    class Clock(_message.Message):
        ...
        def __init__(self, clock_id: _Optional[int] = ..., timestamp: _Optional[int] = ..., is_incremental: _Optional[bool] = ..., unit_multiplier_ns: _Optional[int] = ...) -> None: ...
...
class CSwitchEtwEvent(_message.Message):
    __slots__ = ("new_thread_id", "old_thread_id", "new_thread_priority", "old_thread_priority", "previous_c_state", "old_thread_wait_reason", "old_thread_wait_reason_int", "old_thread_wait_mode", "old_thread_wait_mode_int", "old_thread_state", "old_thread_state_int", "old_thread_wait_ideal_processor", "new_thread_wait_time")
...
class ReadyThreadEtwEvent(_message.Message):
    __slots__ = ("t_thread_id", "adjust_reason", "adjust_reason_int", "adjust_increment", "flag", "flag_int")
...
class MemInfoEtwEvent(_message.Message):
    __slots__ = ("priority_levels", "zero_page_count", "free_page_count", "modified_page_count", "modified_no_write_page_count", "bad_page_count", "standby_page_counts", "repurposed_page_counts", "modified_page_count_page_file", "paged_pool_page_count", "non_paged_pool_page_count", "mdl_page_count", "commit_page_count")
...
class FileIoCreateEtwEvent(_message.Message):
    __slots__ = ("irp_ptr", "file_object", "ttid", "create_options", "file_attributes", "share_access", "open_path")
...
class FileIoDirEnumEtwEvent(_message.Message):
    __slots__ = ("irp_ptr", "file_object", "file_key", "ttid", "length", "info_class", "file_index", "file_name", "opcode")
    IRP_PTR_FIELD_NUMBER: _ClassVar[int]
    FILE_OBJECT_FIELD_NUMBER: _ClassVar[int]
...
class FileIoInfoEtwEvent(_message.Message):
    __slots__ = ("irp_ptr", "file_object", "file_key", "extra_info", "ttid", "info_class", "opcode")
    IRP_PTR_FIELD_NUMBER: _ClassVar[int]
    FILE_OBJECT_FIELD_NUMBER: _ClassVar[int]
    FILE_KEY_FIELD_NUMBER: _ClassVar[int]
...
class FileIoReadWriteEtwEvent(_message.Message):
    __slots__ = ("offset", "irp_ptr", "file_object", "file_key", "ttid", "io_size", "io_flags", "opcode")
...
class FileIoSimpleOpEtwEvent(_message.Message):
    __slots__ = ("irp_ptr", "file_object", "file_key", "ttid", "opcode")
    IRP_PTR_FIELD_NUMBER: _ClassVar[int]
    FILE_OBJECT_FIELD_NUMBER: _ClassVar[int]
    FILE_KEY_FIELD_NUMBER: _ClassVar[int]
    TTID_FIELD_NUMBER: _ClassVar[int]
...
class FileIoOpEndEtwEvent(_message.Message):
    __slots__ = ("irp_ptr", "extra_info", "nt_status")
    IRP_PTR_FIELD_NUMBER: _ClassVar[int]
    EXTRA_INFO_FIELD_NUMBER: _ClassVar[int]
...
class EvdevEvent(_message.Message):
    __slots__ = ("device_id", "input_event", "add_event", "remove_event")
    class InputEvent(_message.Message):
        __slots__ = ("kernel_timestamp", "type", "code", "value")
    ...
    class DeviceAddition(_message.Message):
        __slots__ = ("device",)
        DEVICE_FIELD_NUMBER: _ClassVar[int]
        device: EvdevDevice
        def __init__(self, device: _Optional[_Union[EvdevDevice, _Mapping]] = ...) -> None: ...
    class DeviceRemoval(_message.Message):
        __slots__ = ()
        def __init__(self) -> None: ...
    DEVICE_ID_FIELD_NUMBER: _ClassVar[int]
    INPUT_EVENT_FIELD_NUMBER: _ClassVar[int]
    ADD_EVENT_FIELD_NUMBER: _ClassVar[int]
    REMOVE_EVENT_FIELD_NUMBER: _ClassVar[int]
    device_id: int
    input_event: EvdevEvent.InputEvent
    add_event: EvdevEvent.DeviceAddition
    remove_event: EvdevEvent.DeviceRemoval
    def __init__(self, device_id: _Optional[int] = ..., input_event: _Optional[_Union[EvdevEvent.InputEvent, _Mapping]] = ..., add_event: _Optional[_Union[EvdevEvent.DeviceAddition, _Mapping]] = ..., remove_event: _Optional[_Union[EvdevEvent.DeviceRemoval, _Mapping]] = ...) -> None: ...

class EvdevDevice(_message.Message):
    __slots__ = ("device_id", "device_num", "name", "phys", "uniq", "id", "absolute_axis_infos", "ev_bitmask", "event_type_bitmasks", "prop_bitmask", "axis_states", "abs_mt_states")
    class Identifier(_message.Message):
        ...
        product: int
        version: int
        def __init__(self, bustype: _Optional[int] = ..., vendor: _Optional[int] = ..., product: _Optional[int] = ..., version: _Optional[int] = ...) -> None: ...
    class AbsInfo(_message.Message):
        __slots__ = ("minimum", "maximum", "fuzz", "flat", "resolution")
        MINIMUM_FIELD_NUMBER: _ClassVar[int]
        MAXIMUM_FIELD_NUMBER: _ClassVar[int]
        FUZZ_FIELD_NUMBER: _ClassVar[int]
        ...
        flat: int
        resolution: int
        def __init__(self, minimum: _Optional[int] = ..., maximum: _Optional[int] = ..., fuzz: _Optional[int] = ..., flat: _Optional[int] = ..., resolution: _Optional[int] = ...) -> None: ...
    class AbsoluteAxisInfosEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: int
        value: EvdevDevice.AbsInfo
        def __init__(self, key: _Optional[int] = ..., value: _Optional[_Union[EvdevDevice.AbsInfo, _Mapping]] = ...) -> None: ...
    class EventTypeBitmasksEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: int
    ...
    class AxisMap(_message.Message):
        __slots__ = ("axis_states",)
        class AxisStatesEntry(_message.Message):
            __slots__ = ("key", "value")
            KEY_FIELD_NUMBER: _ClassVar[int]
            VALUE_FIELD_NUMBER: _ClassVar[int]
            key: int
        ...
        axis_states: _containers.ScalarMap[int, int]
        def __init__(self, axis_states: _Optional[_Mapping[int, int]] = ...) -> None: ...
    class AxisStatesEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: int
        value: EvdevDevice.AxisMap
        def __init__(self, key: _Optional[int] = ..., value: _Optional[_Union[EvdevDevice.AxisMap, _Mapping]] = ...) -> None: ...
    class SlotValuesMap(_message.Message):
        __slots__ = ("slot_values",)
        class SlotValuesEntry(_message.Message):
            __slots__ = ("key", "value")
            KEY_FIELD_NUMBER: _ClassVar[int]
            VALUE_FIELD_NUMBER: _ClassVar[int]
            key: int
            value: int
            def __init__(self, key: _Optional[int] = ..., value: _Optional[int] = ...) -> None: ...
        SLOT_VALUES_FIELD_NUMBER: _ClassVar[int]
        slot_values: _containers.ScalarMap[int, int]
        def __init__(self, slot_values: _Optional[_Mapping[int, int]] = ...) -> None: ...
    class AbsMtStatesEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: int
        value: EvdevDevice.SlotValuesMap
        def __init__(self, key: _Optional[int] = ..., value: _Optional[_Union[EvdevDevice.SlotValuesMap, _Mapping]] = ...) -> None: ...
    DEVICE_ID_FIELD_NUMBER: _ClassVar[int]
    DEVICE_NUM_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    PHYS_FIELD_NUMBER: _ClassVar[int]
    UNIQ_FIELD_NUMBER: _ClassVar[int]
    ID_FIELD_NUMBER: _ClassVar[int]
    ABSOLUTE_AXIS_INFOS_FIELD_NUMBER: _ClassVar[int]
    EV_BITMASK_FIELD_NUMBER: _ClassVar[int]
    EVENT_TYPE_BITMASKS_FIELD_NUMBER: _ClassVar[int]
    PROP_BITMASK_FIELD_NUMBER: _ClassVar[int]
    AXIS_STATES_FIELD_NUMBER: _ClassVar[int]
    ABS_MT_STATES_FIELD_NUMBER: _ClassVar[int]
    device_id: int
    device_num: int
    name: str
    phys: str
    uniq: str
    id: EvdevDevice.Identifier
    absolute_axis_infos: _containers.MessageMap[int, EvdevDevice.AbsInfo]
    ev_bitmask: bytes
    event_type_bitmasks: _containers.ScalarMap[int, bytes]
    prop_bitmask: bytes
    axis_states: _containers.MessageMap[int, EvdevDevice.AxisMap]
    abs_mt_states: _containers.MessageMap[int, EvdevDevice.SlotValuesMap]
    def __init__(self, device_id: _Optional[int] = ..., device_num: _Optional[int] = ..., name: _Optional[str] = ..., phys: _Optional[str] = ..., uniq: _Optional[str] = ..., id: _Optional[_Union[EvdevDevice.Identifier, _Mapping]] = ..., absolute_axis_infos: _Optional[_Mapping[int, EvdevDevice.AbsInfo]] = ..., ev_bitmask: _Optional[bytes] = ..., event_type_bitmasks: _Optional[_Mapping[int, bytes]] = ..., prop_bitmask: _Optional[bytes] = ..., axis_states: _Optional[_Mapping[int, EvdevDevice.AxisMap]] = ..., abs_mt_states: _Optional[_Mapping[int, EvdevDevice.SlotValuesMap]] = ...) -> None: ...
...
class UninterpretedOption(_message.Message):
    ...
    class NamePart(_message.Message):
        ...
        name_part: str
        is_extension: bool
        def __init__(self, name_part: _Optional[str] = ..., is_extension: _Optional[bool] = ...) -> None: ...
    NAME_FIELD_NUMBER: _ClassVar[int]
...
class FieldOptions(_message.Message):
    ...
    def __init__(self, packed: _Optional[bool] = ..., uninterpreted_option: _Optional[_Iterable[_Union[UninterpretedOption, _Mapping]]] = ...) -> None: ...
...
class ExtensionDescriptor(_message.Message):
    __slots__ = ("extension_set", "extension_set_gzip", "file_name")
    EXTENSION_SET_FIELD_NUMBER: _ClassVar[int]
    EXTENSION_SET_GZIP_FIELD_NUMBER: _ClassVar[int]
    FILE_NAME_FIELD_NUMBER: _ClassVar[int]
    extension_set: FileDescriptorSet
    extension_set_gzip: bytes
    file_name: str
    def __init__(self, extension_set: _Optional[_Union[FileDescriptorSet, _Mapping]] = ..., extension_set_gzip: _Optional[bytes] = ..., file_name: _Optional[str] = ...) -> None: ...
...
class BclIrqTriggerFtraceEvent(_message.Message):
    __slots__ = ("id", "throttle", "cpu0_limit", "cpu1_limit", "cpu2_limit", "tpu_limit", "gpu_limit", "voltage", "capacity")
    ID_FIELD_NUMBER: _ClassVar[int]
...
class BlockIoStartFtraceEvent(_message.Message):
    __slots__ = ("dev", "sector", "nr_sector", "bytes", "ioprio", "rwbs", "comm", "cmd")
    DEV_FIELD_NUMBER: _ClassVar[int]
    SECTOR_FIELD_NUMBER: _ClassVar[int]
    NR_SECTOR_FIELD_NUMBER: _ClassVar[int]
    BYTES_FIELD_NUMBER: _ClassVar[int]
...
class CmaAllocFinishFtraceEvent(_message.Message):
    __slots__ = ("name", "pfn", "page", "count", "align", "errorno")
    NAME_FIELD_NUMBER: _ClassVar[int]
    PFN_FIELD_NUMBER: _ClassVar[int]
...
class ParamSetValueCpmFtraceEvent(_message.Message):
    __slots__ = ("body", "value", "timestamp")
...
class DevfreqFrequencyFtraceEvent(_message.Message):
    __slots__ = ("dev_name", "freq", "prev_freq", "busy_time", "total_time")
...
class Dwc3AllocRequestFtraceEvent(_message.Message):
    __slots__ = ("name", "req", "actual", "length", "status", "zero", "short_not_ok", "no_interrupt")
    NAME_FIELD_NUMBER: _ClassVar[int]
...
class Dwc3CompleteTrbFtraceEvent(_message.Message):
    __slots__ = ("name", "trb", "allocated", "queued", "bpl", "bph", "size", "ctrl", "type", "enqueue", "dequeue")
    NAME_FIELD_NUMBER: _ClassVar[int]
...
class Dwc3CtrlReqFtraceEvent(_message.Message):
    __slots__ = ("bRequestType", "bRequest", "wValue", "wIndex", "wLength", "str")
...
class Dwc3GadgetEpCmdFtraceEvent(_message.Message):
    __slots__ = ("name", "cmd", "param0", "param1", "param2", "cmd_status")
    NAME_FIELD_NUMBER: _ClassVar[int]
    CMD_FIELD_NUMBER: _ClassVar[int]
...
class Dwc3GadgetEpDisableFtraceEvent(_message.Message):
    __slots__ = ("name", "maxpacket", "maxpacket_limit", "max_streams", "maxburst", "flags", "direction", "trb_enqueue", "trb_dequeue")
    NAME_FIELD_NUMBER: _ClassVar[int]
...
class Dwc3ReadlFtraceEvent(_message.Message):
    __slots__ = ("base", "offset", "value", "msg")
...
class F2fsWriteCheckpointFtraceEvent(_message.Message):
    __slots__ = ("dev", "is_umount", "msg", "reason", "phase")
    DEV_FIELD_NUMBER: _ClassVar[int]
...
class F2fsBackgroundGcFtraceEvent(_message.Message):
    __slots__ = ("dev", "wait_ms", "prefree", "free")
    DEV_FIELD_NUMBER: _ClassVar[int]
...
class F2fsGcBeginFtraceEvent(_message.Message):
    __slots__ = ("dev", "sync", "background", "dirty_nodes", "dirty_dents", "dirty_imeta", "free_sec", "free_seg", "reserved_seg", "prefree_seg", "gc_type", "no_bg_gc", "nr_free_secs")
    DEV_FIELD_NUMBER: _ClassVar[int]
    SYNC_FIELD_NUMBER: _ClassVar[int]
...
class F2fsGcEndFtraceEvent(_message.Message):
    __slots__ = ("dev", "ret", "seg_freed", "sec_freed", "dirty_nodes", "dirty_dents", "dirty_imeta", "free_sec", "free_seg", "reserved_seg", "prefree_seg")
    DEV_FIELD_NUMBER: _ClassVar[int]
    RET_FIELD_NUMBER: _ClassVar[int]
...
class F2fsLockElapsedTimeFtraceEvent(_message.Message):
    __slots__ = ("dev", "comm", "pid", "prio", "ioprio_class", "ioprio_data", "lock_name", "is_write", "total_time", "running_time", "runnable_time", "io_sleep_time", "other_time")
    DEV_FIELD_NUMBER: _ClassVar[int]
    COMM_FIELD_NUMBER: _ClassVar[int]
    PID_FIELD_NUMBER: _ClassVar[int]
    PRIO_FIELD_NUMBER: _ClassVar[int]
    IOPRIO_CLASS_FIELD_NUMBER: _ClassVar[int]
    IOPRIO_DATA_FIELD_NUMBER: _ClassVar[int]
    LOCK_NAME_FIELD_NUMBER: _ClassVar[int]
    IS_WRITE_FIELD_NUMBER: _ClassVar[int]
    TOTAL_TIME_FIELD_NUMBER: _ClassVar[int]
    RUNNING_TIME_FIELD_NUMBER: _ClassVar[int]
    RUNNABLE_TIME_FIELD_NUMBER: _ClassVar[int]
    IO_SLEEP_TIME_FIELD_NUMBER: _ClassVar[int]
    OTHER_TIME_FIELD_NUMBER: _ClassVar[int]
    dev: int
    comm: str
    pid: int
    prio: int
    ...
    io_sleep_time: int
    other_time: int
    def __init__(self, dev: _Optional[int] = ..., comm: _Optional[str] = ..., pid: _Optional[int] = ..., prio: _Optional[int] = ..., ioprio_class: _Optional[int] = ..., ioprio_data: _Optional[int] = ..., lock_name: _Optional[int] = ..., is_write: _Optional[int] = ..., total_time: _Optional[int] = ..., running_time: _Optional[int] = ..., runnable_time: _Optional[int] = ..., io_sleep_time: _Optional[int] = ..., other_time: _Optional[int] = ...) -> None: ...
...
class FastrpcDmaAllocFtraceEvent(_message.Message):
    __slots__ = ("cid", "phys", "size", "attr", "mflags")
    CID_FIELD_NUMBER: _ClassVar[int]
    PHYS_FIELD_NUMBER: _ClassVar[int]
    SIZE_FIELD_NUMBER: _ClassVar[int]
...
class FastrpcDmaMapFtraceEvent(_message.Message):
    __slots__ = ("cid", "fd", "phys", "size", "len", "attr", "mflags")
    CID_FIELD_NUMBER: _ClassVar[int]
...
class FwtpPerfettoCounterFtraceEvent(_message.Message):
    __slots__ = ("timestamp", "track_id", "category", "name", "value")
    TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
...
class FwtpPerfettoSliceFtraceEvent(_message.Message):
    __slots__ = ("timestamp", "track_id", "category", "name", "begin")
    TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
    TRACK_ID_FIELD_NUMBER: _ClassVar[int]
    CATEGORY_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    name: str
    begin: int
    def __init__(self, timestamp: _Optional[int] = ..., track_id: _Optional[int] = ..., category: _Optional[str] = ..., name: _Optional[str] = ..., begin: _Optional[int] = ...) -> None: ...
...
class KprobeEvent(_message.Message):
    ...
    class KprobeType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        KPROBE_TYPE_UNKNOWN: _ClassVar[KprobeEvent.KprobeType]
        KPROBE_TYPE_BEGIN: _ClassVar[KprobeEvent.KprobeType]
        KPROBE_TYPE_END: _ClassVar[KprobeEvent.KprobeType]
        KPROBE_TYPE_INSTANT: _ClassVar[KprobeEvent.KprobeType]
...
class DrmSchedJobAddDepFtraceEvent(_message.Message):
    __slots__ = ("fence_context", "fence_seqno", "ctx", "seqno")
...
class DrmSchedJobQueueFtraceEvent(_message.Message):
    __slots__ = ("name", "job_count", "hw_job_count", "dev", "fence_context", "fence_seqno", "client_id")
    NAME_FIELD_NUMBER: _ClassVar[int]
    JOB_COUNT_FIELD_NUMBER: _ClassVar[int]
    HW_JOB_COUNT_FIELD_NUMBER: _ClassVar[int]
    DEV_FIELD_NUMBER: _ClassVar[int]
...
class HostFfaCallFtraceEvent(_message.Message):
    __slots__ = ("func_id", "res_a1", "res_a2", "res_a3", "res_a4", "handled", "err")
...
class KgslAdrenoCmdbatchQueuedFtraceEvent(_message.Message):
    __slots__ = ("id", "timestamp", "queued", "flags", "prio")
    ID_FIELD_NUMBER: _ClassVar[int]
    TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
    QUEUED_FIELD_NUMBER: _ClassVar[int]
    FLAGS_FIELD_NUMBER: _ClassVar[int]
...
class KgslAdrenoCmdbatchSubmittedFtraceEvent(_message.Message):
    __slots__ = ("id", "timestamp", "inflight", "flags", "ticks", "secs", "usecs", "prio", "rb_id", "rptr", "wptr", "q_inflight", "dispatch_queue")
    ID_FIELD_NUMBER: _ClassVar[int]
    TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
...
class KgslAdrenoCmdbatchSyncFtraceEvent(_message.Message):
    __slots__ = ("id", "timestamp", "ticks", "prio")
    ID_FIELD_NUMBER: _ClassVar[int]
    TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
    TICKS_FIELD_NUMBER: _ClassVar[int]
    PRIO_FIELD_NUMBER: _ClassVar[int]
...
class KgslAdrenoCmdbatchRetiredFtraceEvent(_message.Message):
    __slots__ = ("id", "timestamp", "inflight", "recovery", "flags", "start", "retire", "prio", "rb_id", "rptr", "wptr", "q_inflight", "fault_recovery", "dispatch_queue", "submitted_to_rb", "retired_on_gmu", "active")
    ID_FIELD_NUMBER: _ClassVar[int]
    TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
    INFLIGHT_FIELD_NUMBER: _ClassVar[int]
...
class MmAllocContigMigrateRangeInfoFtraceEvent(_message.Message):
    __slots__ = ("start", "end", "nr_migrated", "nr_reclaimed", "nr_mapped", "migratetype")
    START_FIELD_NUMBER: _ClassVar[int]
    END_FIELD_NUMBER: _ClassVar[int]
    NR_MIGRATED_FIELD_NUMBER: _ClassVar[int]
    NR_RECLAIMED_FIELD_NUMBER: _ClassVar[int]
...
class GramCollisionFtraceEvent(_message.Message):
    __slots__ = ("panel_index", "collision_cnt")
    PANEL_INDEX_FIELD_NUMBER: _ClassVar[int]
    COLLISION_CNT_FIELD_NUMBER: _ClassVar[int]
    panel_index: int
    collision_cnt: int
    def __init__(self, panel_index: _Optional[int] = ..., collision_cnt: _Optional[int] = ...) -> None: ...

class SchedSwitchWithCtrsFtraceEvent(_message.Message):
    __slots__ = ("old_pid", "new_pid", "cctr", "ctr0", "ctr1", "ctr2", "ctr3", "lctr0", "lctr1", "ctr4", "ctr5", "prev_comm", "prev_pid", "cyc", "inst", "stallbm", "l3dm", "next_pid", "next_comm", "prev_state", "amu0", "amu1", "amu2")
...
class PixelMmKswapdDoneFtraceEvent(_message.Message):
    __slots__ = ("delta_nr_scanned", "delta_nr_reclaimed", "delta_nr_allocated", "duration_ns")
...
class DevicePmCallbackStartFtraceEvent(_message.Message):
    __slots__ = ("device", "driver", "parent", "pm_ops", "event")
    DEVICE_FIELD_NUMBER: _ClassVar[int]
    DRIVER_FIELD_NUMBER: _ClassVar[int]
    PARENT_FIELD_NUMBER: _ClassVar[int]
...
class GpuPowerStateFtraceEvent(_message.Message):
    __slots__ = ("old_state", "new_state")
    OLD_STATE_FIELD_NUMBER: _ClassVar[int]
    NEW_STATE_FIELD_NUMBER: _ClassVar[int]
    old_state: int
    new_state: int
    def __init__(self, old_state: _Optional[int] = ..., new_state: _Optional[int] = ...) -> None: ...
...
class SchedMigrateTaskFtraceEvent(_message.Message):
    __slots__ = ("comm", "pid", "prio", "orig_cpu", "dest_cpu", "running", "load")
    COMM_FIELD_NUMBER: _ClassVar[int]
    PID_FIELD_NUMBER: _ClassVar[int]
    PRIO_FIELD_NUMBER: _ClassVar[int]
...
class ThermalExynosAcpmBulkFtraceEvent(_message.Message):
    __slots__ = ("tz_id", "current_temp", "ctrl_temp", "cdev_state", "pid_et_p", "pid_power_range", "pid_p", "pid_i", "k_p", "k_i", "timestamp")
...
class ThermalExynosAcpmHighOverheadFtraceEvent(_message.Message):
    __slots__ = ("tz_id", "current_temp", "ctrl_temp", "cdev_state", "pid_et_p", "k_p", "k_i")
    TZ_ID_FIELD_NUMBER: _ClassVar[int]
    CURRENT_TEMP_FIELD_NUMBER: _ClassVar[int]
    CTRL_TEMP_FIELD_NUMBER: _ClassVar[int]
    CDEV_STATE_FIELD_NUMBER: _ClassVar[int]
...
class HrtimerStartFtraceEvent(_message.Message):
    __slots__ = ("hrtimer", "function", "expires", "softexpires", "mode")
...
class HrtimerExpireEntryFtraceEvent(_message.Message):
    __slots__ = ("hrtimer", "now", "function")
    HRTIMER_FIELD_NUMBER: _ClassVar[int]
    NOW_FIELD_NUMBER: _ClassVar[int]
    FUNCTION_FIELD_NUMBER: _ClassVar[int]
    hrtimer: int
...
class TimerStartFtraceEvent(_message.Message):
    __slots__ = ("timer", "function", "expires", "now", "deferrable", "flags", "bucket_expiry")
...
class TimerExpireEntryFtraceEvent(_message.Message):
    __slots__ = ("timer", "now", "function", "baseclk")
    TIMER_FIELD_NUMBER: _ClassVar[int]
    NOW_FIELD_NUMBER: _ClassVar[int]
    FUNCTION_FIELD_NUMBER: _ClassVar[int]
...
class WorkqueueQueueWorkFtraceEvent(_message.Message):
    __slots__ = ("work", "function", "req_cpu", "cpu", "workqueue")
    WORK_FIELD_NUMBER: _ClassVar[int]
    FUNCTION_FIELD_NUMBER: _ClassVar[int]
...
class FtraceEvent(_message.Message):
    ...
    FWTP_PERFETTO_SLICE_FIELD_NUMBER: _ClassVar[int]
    GPU_POWER_STATE_FIELD_NUMBER: _ClassVar[int]
    GRAM_COLLISION_FIELD_NUMBER: _ClassVar[int]
    F2FS_LOCK_ELAPSED_TIME_FIELD_NUMBER: _ClassVar[int]
    timestamp: int
    pid: int
    common_flags: int
...
class FtraceStats(_message.Message):
    __slots__ = ("phase", "cpu_stats", "kernel_symbols_parsed", "kernel_symbols_mem_kb", "atrace_errors", "exclusive_feature_error", "unknown_ftrace_events", "failed_ftrace_events", "preserve_ftrace_buffer", "ftrace_parse_errors", "kprobe_stats", "cpu_buffer_size_pages", "cached_cpu_buffer_size_pages")
    ...
    def __init__(self, phase: _Optional[_Union[FtraceStats.Phase, str]] = ..., cpu_stats: _Optional[_Iterable[_Union[FtraceCpuStats, _Mapping]]] = ..., kernel_symbols_parsed: _Optional[int] = ..., kernel_symbols_mem_kb: _Optional[int] = ..., atrace_errors: _Optional[str] = ..., exclusive_feature_error: _Optional[str] = ..., unknown_ftrace_events: _Optional[_Iterable[str]] = ..., failed_ftrace_events: _Optional[_Iterable[str]] = ..., preserve_ftrace_buffer: _Optional[bool] = ..., ftrace_parse_errors: _Optional[_Iterable[_Union[FtraceParseStatus, str]]] = ..., kprobe_stats: _Optional[_Union[FtraceKprobeStats, _Mapping]] = ..., cpu_buffer_size_pages: _Optional[int] = ..., cached_cpu_buffer_size_pages: _Optional[int] = ...) -> None: ...

class FtraceEventBundle(_message.Message):
    __slots__ = ("cpu", "event", "lost_events", "compact_sched", "ftrace_clock", "ftrace_timestamp", "boot_timestamp", "error", "last_read_event_timestamp", "previous_bundle_end_timestamp", "generic_event_descriptors", "broken_abi_trace_page")
    ...
    class GenericEventDescriptor(_message.Message):
        __slots__ = ("field_id", "group_name", "event_descriptor")
        FIELD_ID_FIELD_NUMBER: _ClassVar[int]
...
class GenericKernelTaskStateEvent(_message.Message):
    __slots__ = ("cpu", "comm", "tid", "state", "prio")
    class TaskStateEnum(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        TASK_STATE_UNKNOWN: _ClassVar[GenericKernelTaskStateEvent.TaskStateEnum]
        TASK_STATE_CREATED: _ClassVar[GenericKernelTaskStateEvent.TaskStateEnum]
        TASK_STATE_RUNNABLE: _ClassVar[GenericKernelTaskStateEvent.TaskStateEnum]
        TASK_STATE_RUNNING: _ClassVar[GenericKernelTaskStateEvent.TaskStateEnum]
        TASK_STATE_INTERRUPTIBLE_SLEEP: _ClassVar[GenericKernelTaskStateEvent.TaskStateEnum]
        TASK_STATE_UNINTERRUPTIBLE_SLEEP: _ClassVar[GenericKernelTaskStateEvent.TaskStateEnum]
        TASK_STATE_STOPPED: _ClassVar[GenericKernelTaskStateEvent.TaskStateEnum]
        TASK_STATE_DEAD: _ClassVar[GenericKernelTaskStateEvent.TaskStateEnum]
        TASK_STATE_DESTROYED: _ClassVar[GenericKernelTaskStateEvent.TaskStateEnum]
...
class GenericKernelProcessTree(_message.Message):
    ...
    class Thread(_message.Message):
        __slots__ = ("tid", "pid", "comm", "is_main_thread", "is_idle")
        TID_FIELD_NUMBER: _ClassVar[int]
        PID_FIELD_NUMBER: _ClassVar[int]
        COMM_FIELD_NUMBER: _ClassVar[int]
        ...
        is_main_thread: bool
        is_idle: bool
        def __init__(self, tid: _Optional[int] = ..., pid: _Optional[int] = ..., comm: _Optional[str] = ..., is_main_thread: _Optional[bool] = ..., is_idle: _Optional[bool] = ...) -> None: ...
    class Process(_message.Message):
        __slots__ = ("pid", "ppid", "cmdline")
        PID_FIELD_NUMBER: _ClassVar[int]
...
class Frame(_message.Message):
    __slots__ = ("iid", "function_name_id", "mapping_id", "rel_pc", "source_path_iid", "line_number")
    IID_FIELD_NUMBER: _ClassVar[int]
...
class ChromeCompositorStateMachine(_message.Message):
    ...
    class MinorState(_message.Message):
        ...
        def __init__(self, commit_count: _Optional[int] = ..., current_frame_number: _Optional[int] = ..., last_frame_number_submit_performed: _Optional[int] = ..., last_frame_number_draw_performed: _Optional[int] = ..., last_frame_number_begin_main_frame_sent: _Optional[int] = ..., did_draw: _Optional[bool] = ..., did_send_begin_main_frame_for_current_frame: _Optional[bool] = ..., did_notify_begin_main_frame_not_expected_until: _Optional[bool] = ..., did_notify_begin_main_frame_not_expected_soon: _Optional[bool] = ..., wants_begin_main_frame_not_expected: _Optional[bool] = ..., did_commit_during_frame: _Optional[bool] = ..., did_invalidate_layer_tree_frame_sink: _Optional[bool] = ..., did_perform_impl_side_invalidaion: _Optional[bool] = ..., did_prepare_tiles: _Optional[bool] = ..., consecutive_checkerboard_animations: _Optional[int] = ..., pending_submit_frames: _Optional[int] = ..., submit_frames_with_current_layer_tree_frame_sink: _Optional[int] = ..., needs_redraw: _Optional[bool] = ..., needs_prepare_tiles: _Optional[bool] = ..., needs_begin_main_frame: _Optional[bool] = ..., needs_one_begin_impl_frame: _Optional[bool] = ..., visible: _Optional[bool] = ..., begin_frame_source_paused: _Optional[bool] = ..., can_draw: _Optional[bool] = ..., resourceless_draw: _Optional[bool] = ..., has_pending_tree: _Optional[bool] = ..., pending_tree_is_ready_for_activation: _Optional[bool] = ..., active_tree_needs_first_draw: _Optional[bool] = ..., active_tree_is_ready_to_draw: _Optional[bool] = ..., did_create_and_initialize_first_layer_tree_frame_sink: _Optional[bool] = ..., tree_priority: _Optional[_Union[ChromeCompositorStateMachine.MinorState.TreePriority, str]] = ..., scroll_handler_state: _Optional[_Union[ChromeCompositorStateMachine.MinorState.ScrollHandlerState, str]] = ..., critical_begin_main_frame_to_activate_is_fast: _Optional[bool] = ..., main_thread_missed_last_deadline: _Optional[bool] = ..., video_needs_begin_frames: _Optional[bool] = ..., defer_begin_main_frame: _Optional[bool] = ..., last_commit_had_no_updates: _Optional[bool] = ..., did_draw_in_last_frame: _Optional[bool] = ..., did_submit_in_last_frame: _Optional[bool] = ..., needs_impl_side_invalidation: _Optional[bool] = ..., current_pending_tree_is_impl_side: _Optional[bool] = ..., previous_pending_tree_was_impl_side: _Optional[bool] = ..., processing_animation_worklets_for_active_tree: _Optional[bool] = ..., processing_animation_worklets_for_pending_tree: _Optional[bool] = ..., processing_paint_worklets_for_pending_tree: _Optional[bool] = ...) -> None: ...
...
class BeginFrameArgs(_message.Message):
    ...
    def __init__(self, type: _Optional[_Union[BeginFrameArgs.BeginFrameArgsType, str]] = ..., source_id: _Optional[int] = ..., sequence_number: _Optional[int] = ..., frame_time_us: _Optional[int] = ..., deadline_us: _Optional[int] = ..., interval_delta_us: _Optional[int] = ..., on_critical_path: _Optional[bool] = ..., animate_only: _Optional[bool] = ..., source_location_iid: _Optional[int] = ..., source_location: _Optional[_Union[SourceLocation, _Mapping]] = ..., frames_throttled_since_last: _Optional[int] = ...) -> None: ...
...
class BeginFrameSourceState(_message.Message):
    ...
    num_observers: int
    last_begin_frame_args: BeginFrameArgs
    def __init__(self, source_id: _Optional[int] = ..., paused: _Optional[bool] = ..., num_observers: _Optional[int] = ..., last_begin_frame_args: _Optional[_Union[BeginFrameArgs, _Mapping]] = ...) -> None: ...
...
class ChromeFrameReporter(_message.Message):
    __slots__ = ("state", "reason", "frame_source", "frame_sequence", "affects_smoothness", "scroll_state", "has_main_animation", "has_compositor_animation", "has_smooth_input_main", "has_missing_content", "layer_tree_host_id", "has_high_latency", "frame_type", "high_latency_contribution_stage", "checkerboarded_needs_raster", "checkerboarded_needs_record", "surface_frame_trace_id", "display_trace_id")
    class State(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
    ...
    class ScrollState(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        SCROLL_RASTER: _ClassVar[ChromeFrameReporter.ScrollState]
    ...
    def __init__(self, state: _Optional[_Union[ChromeFrameReporter.State, str]] = ..., reason: _Optional[_Union[ChromeFrameReporter.FrameDropReason, str]] = ..., frame_source: _Optional[int] = ..., frame_sequence: _Optional[int] = ..., affects_smoothness: _Optional[bool] = ..., scroll_state: _Optional[_Union[ChromeFrameReporter.ScrollState, str]] = ..., has_main_animation: _Optional[bool] = ..., has_compositor_animation: _Optional[bool] = ..., has_smooth_input_main: _Optional[bool] = ..., has_missing_content: _Optional[bool] = ..., layer_tree_host_id: _Optional[int] = ..., has_high_latency: _Optional[bool] = ..., frame_type: _Optional[_Union[ChromeFrameReporter.FrameType, str]] = ..., high_latency_contribution_stage: _Optional[_Iterable[str]] = ..., checkerboarded_needs_raster: _Optional[bool] = ..., checkerboarded_needs_record: _Optional[bool] = ..., surface_frame_trace_id: _Optional[int] = ..., display_trace_id: _Optional[int] = ...) -> None: ...
...
class ChromeLatencyInfo(_message.Message):
    __slots__ = ("trace_id", "step", "frame_tree_node_id", "component_info", "is_coalesced", "gesture_scroll_id", "touch_id", "input_type")
    ...
    class InputType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        UNSPECIFIED_OR_OTHER: _ClassVar[ChromeLatencyInfo.InputType]
        TOUCH_MOVED: _ClassVar[ChromeLatencyInfo.InputType]
        GESTURE_SCROLL_BEGIN: _ClassVar[ChromeLatencyInfo.InputType]
        GESTURE_SCROLL_UPDATE: _ClassVar[ChromeLatencyInfo.InputType]
        GESTURE_SCROLL_END: _ClassVar[ChromeLatencyInfo.InputType]
        GESTURE_TAP: _ClassVar[ChromeLatencyInfo.InputType]
        GESTURE_TAP_CANCEL: _ClassVar[ChromeLatencyInfo.InputType]
...
class ChromeMessagePump(_message.Message):
    ...
    def __init__(self, sent_messages_in_queue: _Optional[bool] = ..., io_handler_location_iid: _Optional[int] = ...) -> None: ...
...
class ChromeMojoEventInfo(_message.Message):
    ...
    payload_size: int
    data_num_bytes: int
    def __init__(self, watcher_notify_interface_tag: _Optional[str] = ..., ipc_hash: _Optional[int] = ..., mojo_interface_tag: _Optional[str] = ..., mojo_interface_method_iid: _Optional[int] = ..., is_reply: _Optional[bool] = ..., payload_size: _Optional[int] = ..., data_num_bytes: _Optional[int] = ...) -> None: ...
...
class ChromeRendererSchedulerState(_message.Message):
    ...
    is_hidden: bool
    def __init__(self, rail_mode: _Optional[_Union[ChromeRAILMode, str]] = ..., is_backgrounded: _Optional[bool] = ..., is_hidden: _Optional[bool] = ...) -> None: ...
...
class MemoryTrackerSnapshot(_message.Message):
    ...
    class ProcessSnapshot(_message.Message):
        ...
        class MemoryNode(_message.Message):
            ...
            def __init__(self, id: _Optional[int] = ..., absolute_name: _Optional[str] = ..., weak: _Optional[bool] = ..., size_bytes: _Optional[int] = ..., entries: _Optional[_Iterable[_Union[MemoryTrackerSnapshot.ProcessSnapshot.MemoryNode.MemoryNodeEntry, _Mapping]]] = ...) -> None: ...
        class MemoryEdge(_message.Message):
            ...
            importance: int
            overridable: bool
            def __init__(self, source_id: _Optional[int] = ..., target_id: _Optional[int] = ..., importance: _Optional[int] = ..., overridable: _Optional[bool] = ...) -> None: ...
        PID_FIELD_NUMBER: _ClassVar[int]
...
class PerfettoMetatrace(_message.Message):
    ...
    def __init__(self, event_id: _Optional[int] = ..., counter_id: _Optional[int] = ..., event_name: _Optional[str] = ..., event_name_iid: _Optional[int] = ..., counter_name: _Optional[str] = ..., event_duration_ns: _Optional[int] = ..., counter_value: _Optional[int] = ..., thread_id: _Optional[int] = ..., has_overruns: _Optional[bool] = ..., args: _Optional[_Iterable[_Union[PerfettoMetatrace.Arg, _Mapping]]] = ..., interned_strings: _Optional[_Iterable[_Union[PerfettoMetatrace.InternedString, _Mapping]]] = ...) -> None: ...

class TraceProvenance(_message.Message):
    __slots__ = ("buffers",)
    class Sequence(_message.Message):
        __slots__ = ("id", "producer_id")
        ID_FIELD_NUMBER: _ClassVar[int]
        PRODUCER_ID_FIELD_NUMBER: _ClassVar[int]
        id: int
        producer_id: int
        def __init__(self, id: _Optional[int] = ..., producer_id: _Optional[int] = ...) -> None: ...
    class Buffer(_message.Message):
        __slots__ = ("sequences",)
        SEQUENCES_FIELD_NUMBER: _ClassVar[int]
        sequences: _containers.RepeatedCompositeFieldContainer[TraceProvenance.Sequence]
        def __init__(self, sequences: _Optional[_Iterable[_Union[TraceProvenance.Sequence, _Mapping]]] = ...) -> None: ...
    BUFFERS_FIELD_NUMBER: _ClassVar[int]
    buffers: _containers.RepeatedCompositeFieldContainer[TraceProvenance.Buffer]
    def __init__(self, buffers: _Optional[_Iterable[_Union[TraceProvenance.Buffer, _Mapping]]] = ...) -> None: ...

class TracingServiceEvent(_message.Message):
    __slots__ = ("tracing_started", "all_data_sources_started", "flush_started", "all_data_sources_flushed", "read_tracing_buffers_completed", "tracing_disabled", "seized_for_bugreport", "slow_starting_data_sources", "last_flush_slow_data_sources", "clone_started", "buffer_cloned")
    class DataSources(_message.Message):
        __slots__ = ("data_source",)
        class DataSource(_message.Message):
            __slots__ = ("producer_name", "data_source_name")
            PRODUCER_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    clone_started: bool
    buffer_cloned: int
    def __init__(self, tracing_started: _Optional[bool] = ..., all_data_sources_started: _Optional[bool] = ..., flush_started: _Optional[bool] = ..., all_data_sources_flushed: _Optional[bool] = ..., read_tracing_buffers_completed: _Optional[bool] = ..., tracing_disabled: _Optional[bool] = ..., seized_for_bugreport: _Optional[bool] = ..., slow_starting_data_sources: _Optional[_Union[TracingServiceEvent.DataSources, _Mapping]] = ..., last_flush_slow_data_sources: _Optional[_Union[TracingServiceEvent.DataSources, _Mapping]] = ..., clone_started: _Optional[bool] = ..., buffer_cloned: _Optional[int] = ...) -> None: ...
...
class PowerRails(_message.Message):
    __slots__ = ("rail_descriptor", "energy_data", "session_uuid")
...
class ObfuscatedMember(_message.Message):
    ...
    OBFUSCATED_LINE_START_FIELD_NUMBER: _ClassVar[int]
    OBFUSCATED_LINE_END_FIELD_NUMBER: _ClassVar[int]
    SOURCE_LINE_START_FIELD_NUMBER: _ClassVar[int]
    SOURCE_LINE_END_FIELD_NUMBER: _ClassVar[int]
    obfuscated_name: str
    deobfuscated_name: str
    obfuscated_line_start: int
    obfuscated_line_end: int
...
class ProfilePacket(_message.Message):
    ...
    class Histogram(_message.Message):
        ...
        class Bucket(_message.Message):
            ...
            max_bucket: bool
            count: int
            def __init__(self, upper_limit: _Optional[int] = ..., max_bucket: _Optional[bool] = ..., count: _Optional[int] = ...) -> None: ...
    ...
    class ProcessHeapSamples(_message.Message):
        ...
        def __init__(self, pid: _Optional[int] = ..., from_startup: _Optional[bool] = ..., rejected_concurrent: _Optional[bool] = ..., disconnected: _Optional[bool] = ..., buffer_overran: _Optional[bool] = ..., client_error: _Optional[_Union[ProfilePacket.ProcessHeapSamples.ClientError, str]] = ..., buffer_corrupted: _Optional[bool] = ..., hit_guardrail: _Optional[bool] = ..., heap_name: _Optional[str] = ..., sampling_interval_bytes: _Optional[int] = ..., orig_sampling_interval_bytes: _Optional[int] = ..., timestamp: _Optional[int] = ..., stats: _Optional[_Union[ProfilePacket.ProcessStats, _Mapping]] = ..., samples: _Optional[_Iterable[_Union[ProfilePacket.HeapSample, _Mapping]]] = ...) -> None: ...
...
class PerfSample(_message.Message):
    __slots__ = ("cpu", "pid", "tid", "cpu_mode", "timebase_count", "follower_counts", "callstack_iid", "unwind_error", "kernel_records_lost", "sample_skipped_reason", "producer_event")
    class SampleSkipReason(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        PROFILER_SKIP_NOT_IN_SCOPE: _ClassVar[PerfSample.SampleSkipReason]
...
class PerfSampleDefaults(_message.Message):
    __slots__ = ("timebase", "followers", "process_shard_count", "chosen_process_shard")
    TIMEBASE_FIELD_NUMBER: _ClassVar[int]
    FOLLOWERS_FIELD_NUMBER: _ClassVar[int]
    PROCESS_SHARD_COUNT_FIELD_NUMBER: _ClassVar[int]
...
class ProcessStats(_message.Message):
    ...
    class Process(_message.Message):
        __slots__ = ("pid", "threads", "vm_size_kb", "vm_rss_kb", "rss_anon_kb", "rss_file_kb", "rss_shmem_kb", "vm_swap_kb", "vm_locked_kb", "vm_hwm_kb", "oom_score_adj", "is_peak_rss_resettable", "chrome_private_footprint_kb", "chrome_peak_resident_set_kb", "fds", "smr_rss_kb", "smr_pss_kb", "smr_pss_anon_kb", "smr_pss_file_kb", "smr_pss_shmem_kb", "smr_swap_pss_kb", "runtime_user_mode", "runtime_kernel_mode", "dmabuf_rss_kb")
        PID_FIELD_NUMBER: _ClassVar[int]
        THREADS_FIELD_NUMBER: _ClassVar[int]
...
class ProcessTree(_message.Message):
    ...
    class Process(_message.Message):
        __slots__ = ("pid", "ppid", "cmdline", "cmdline_is_comm", "uid", "nspid", "process_start_from_boot", "is_kthread")
        PID_FIELD_NUMBER: _ClassVar[int]
        PPID_FIELD_NUMBER: _ClassVar[int]
        CMDLINE_FIELD_NUMBER: _ClassVar[int]
        ...
        is_kthread: bool
        def __init__(self, pid: _Optional[int] = ..., ppid: _Optional[int] = ..., cmdline: _Optional[_Iterable[str]] = ..., cmdline_is_comm: _Optional[bool] = ..., uid: _Optional[int] = ..., nspid: _Optional[_Iterable[int]] = ..., process_start_from_boot: _Optional[int] = ..., is_kthread: _Optional[bool] = ...) -> None: ...
    PROCESSES_FIELD_NUMBER: _ClassVar[int]
    THREADS_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_END_TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
...
class SysStats(_message.Message):
    ...
    class CpuTimes(_message.Message):
        __slots__ = ("cpu_id", "user_ns", "user_nice_ns", "system_mode_ns", "idle_ns", "io_wait_ns", "irq_ns", "softirq_ns", "steal_ns")
        CPU_ID_FIELD_NUMBER: _ClassVar[int]
...
class CpuInfo(_message.Message):
    ...
    class ArmCpuIdentifier(_message.Message):
        __slots__ = ("implementer", "architecture", "variant", "part", "revision")
    ...
    class Cpu(_message.Message):
        __slots__ = ("processor", "frequencies", "capacity", "arm_identifier", "features")
...
class TestEvent(_message.Message):
    __slots__ = ("str", "seq_value", "counter", "is_last", "payload", "protovm_patch", "protovm_incremental_state")
    ...
    PAYLOAD_FIELD_NUMBER: _ClassVar[int]
    PROTOVM_PATCH_FIELD_NUMBER: _ClassVar[int]
    PROTOVM_INCREMENTAL_STATE_FIELD_NUMBER: _ClassVar[int]
    str: str
    seq_value: int
    counter: int
    is_last: bool
    payload: TestEvent.TestPayload
    protovm_patch: TestEvent.ProtoVmPatch
    protovm_incremental_state: TestEvent.ProtoVmIncrementalState
    def __init__(self, str: _Optional[str] = ..., seq_value: _Optional[int] = ..., counter: _Optional[int] = ..., is_last: _Optional[bool] = ..., payload: _Optional[_Union[TestEvent.TestPayload, _Mapping]] = ..., protovm_patch: _Optional[_Union[TestEvent.ProtoVmPatch, _Mapping]] = ..., protovm_incremental_state: _Optional[_Union[TestEvent.ProtoVmIncrementalState, _Mapping]] = ...) -> None: ...
...
class ChromeThreadDescriptor(_message.Message):
    __slots__ = ("thread_type", "legacy_sort_index", "is_sandboxed_tid")
    ...
    def __init__(self, thread_type: _Optional[int] = ..., legacy_sort_index: _Optional[int] = ..., is_sandboxed_tid: _Optional[bool] = ...) -> None: ...

class CounterDescriptor(_message.Message):
    __slots__ = ("type", "categories", "unit", "unit_name", "unit_multiplier", "is_incremental", "y_axis_share_key")
    ...
    def __init__(self, type: _Optional[_Union[CounterDescriptor.BuiltinCounterType, str]] = ..., categories: _Optional[_Iterable[str]] = ..., unit: _Optional[_Union[CounterDescriptor.Unit, str]] = ..., unit_name: _Optional[str] = ..., unit_multiplier: _Optional[int] = ..., is_incremental: _Optional[bool] = ..., y_axis_share_key: _Optional[str] = ...) -> None: ...
...
class TrackDescriptor(_message.Message):
    ...
    class ChildTracksOrdering(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        LEXICOGRAPHIC: _ClassVar[TrackDescriptor.ChildTracksOrdering]
        CHRONOLOGICAL: _ClassVar[TrackDescriptor.ChildTracksOrdering]
        EXPLICIT: _ClassVar[TrackDescriptor.ChildTracksOrdering]
    ...
    class SiblingMergeBehavior(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        SIBLING_MERGE_BEHAVIOR_UNSPECIFIED: _ClassVar[TrackDescriptor.SiblingMergeBehavior]
        SIBLING_MERGE_BEHAVIOR_BY_TRACK_NAME: _ClassVar[TrackDescriptor.SiblingMergeBehavior]
        SIBLING_MERGE_BEHAVIOR_NONE: _ClassVar[TrackDescriptor.SiblingMergeBehavior]
        SIBLING_MERGE_BEHAVIOR_BY_SIBLING_MERGE_KEY: _ClassVar[TrackDescriptor.SiblingMergeBehavior]
...
class Trigger(_message.Message):
    __slots__ = ("trigger_name", "producer_name", "trusted_producer_uid", "stop_delay_ms")
    TRIGGER_NAME_FIELD_NUMBER: _ClassVar[int]
    PRODUCER_NAME_FIELD_NUMBER: _ClassVar[int]
...
class TracePacket(_message.Message):
    __slots__ = ("timestamp", "timestamp_clock_id", "process_tree", "process_stats", "inode_file_map", "chrome_events", "clock_snapshot", "sys_stats", "track_event", "trace_uuid", "trace_config", "ftrace_stats", "trace_stats", "profile_packet", "streaming_allocation", "streaming_free", "battery", "power_rails", "system_info", "trigger", "chrome_trigger", "chrome_benchmark_metadata", "perfetto_metatrace", "chrome_metadata", "gpu_counter_event", "gpu_render_stage_event", "streaming_profile_packet", "heap_graph", "vulkan_memory_event", "gpu_log", "vulkan_api_event", "perf_sample", "cpu_info", "smaps_packet", "service_event", "memory_tracker_snapshot", "ui_state", "translation_table", "trace_provenance", "protovms", "module_symbols", "deobfuscation_mapping", "track_descriptor", "process_descriptor", "thread_descriptor", "ftrace_events", "synchronization_marker", "compressed_packets", "extension_descriptor", "track_event_range_of_interest", "etw_events", "v8_js_code", "v8_internal_code", "v8_wasm_code", "v8_reg_exp_code", "v8_code_move", "remote_clock_sync", "clone_snapshot_trigger", "generic_kernel_task_state_event", "generic_kernel_cpu_freq_event", "generic_kernel_task_rename_event", "generic_kernel_process_tree", "evdev_event", "for_testing", "trusted_uid", "trusted_packet_sequence_id", "trusted_pid", "interned_data", "sequence_flags", "incremental_state_cleared", "trace_packet_defaults", "previous_packet_dropped", "first_packet_on_sequence", "machine_id")
    ...
    class ProtoVms(_message.Message):
        __slots__ = ("instance",)
        class Instance(_message.Message):
            __slots__ = ("program", "state", "memory_limit_kb", "producer_id")
            ...
            state: TracePacket
            memory_limit_kb: int
            producer_id: _containers.RepeatedScalarFieldContainer[int]
            def __init__(self, program: _Optional[_Union[VmProgram, _Mapping]] = ..., state: _Optional[_Union[TracePacket, _Mapping]] = ..., memory_limit_kb: _Optional[int] = ..., producer_id: _Optional[_Iterable[int]] = ...) -> None: ...
        INSTANCE_FIELD_NUMBER: _ClassVar[int]
        instance: _containers.RepeatedCompositeFieldContainer[TracePacket.ProtoVms.Instance]
    ...
    TRACE_PROVENANCE_FIELD_NUMBER: _ClassVar[int]
    PROTOVMS_FIELD_NUMBER: _ClassVar[int]
    ...
    machine_id: int
    def __init__(self, timestamp: _Optional[int] = ..., timestamp_clock_id: _Optional[int] = ..., process_tree: _Optional[_Union[ProcessTree, _Mapping]] = ..., process_stats: _Optional[_Union[ProcessStats, _Mapping]] = ..., inode_file_map: _Optional[_Union[InodeFileMap, _Mapping]] = ..., chrome_events: _Optional[_Union[ChromeEventBundle, _Mapping]] = ..., clock_snapshot: _Optional[_Union[ClockSnapshot, _Mapping]] = ..., sys_stats: _Optional[_Union[SysStats, _Mapping]] = ..., track_event: _Optional[_Union[TrackEvent, _Mapping]] = ..., trace_uuid: _Optional[_Union[TraceUuid, _Mapping]] = ..., trace_config: _Optional[_Union[TraceConfig, _Mapping]] = ..., ftrace_stats: _Optional[_Union[FtraceStats, _Mapping]] = ..., trace_stats: _Optional[_Union[TraceStats, _Mapping]] = ..., profile_packet: _Optional[_Union[ProfilePacket, _Mapping]] = ..., streaming_allocation: _Optional[_Union[StreamingAllocation, _Mapping]] = ..., streaming_free: _Optional[_Union[StreamingFree, _Mapping]] = ..., battery: _Optional[_Union[BatteryCounters, _Mapping]] = ..., power_rails: _Optional[_Union[PowerRails, _Mapping]] = ..., system_info: _Optional[_Union[SystemInfo, _Mapping]] = ..., trigger: _Optional[_Union[Trigger, _Mapping]] = ..., chrome_trigger: _Optional[_Union[ChromeTrigger, _Mapping]] = ..., chrome_benchmark_metadata: _Optional[_Union[ChromeBenchmarkMetadata, _Mapping]] = ..., perfetto_metatrace: _Optional[_Union[PerfettoMetatrace, _Mapping]] = ..., chrome_metadata: _Optional[_Union[ChromeMetadataPacket, _Mapping]] = ..., gpu_counter_event: _Optional[_Union[GpuCounterEvent, _Mapping]] = ..., gpu_render_stage_event: _Optional[_Union[GpuRenderStageEvent, _Mapping]] = ..., streaming_profile_packet: _Optional[_Union[StreamingProfilePacket, _Mapping]] = ..., heap_graph: _Optional[_Union[HeapGraph, _Mapping]] = ..., vulkan_memory_event: _Optional[_Union[VulkanMemoryEvent, _Mapping]] = ..., gpu_log: _Optional[_Union[GpuLog, _Mapping]] = ..., vulkan_api_event: _Optional[_Union[VulkanApiEvent, _Mapping]] = ..., perf_sample: _Optional[_Union[PerfSample, _Mapping]] = ..., cpu_info: _Optional[_Union[CpuInfo, _Mapping]] = ..., smaps_packet: _Optional[_Union[SmapsPacket, _Mapping]] = ..., service_event: _Optional[_Union[TracingServiceEvent, _Mapping]] = ..., memory_tracker_snapshot: _Optional[_Union[MemoryTrackerSnapshot, _Mapping]] = ..., ui_state: _Optional[_Union[UiState, _Mapping]] = ..., translation_table: _Optional[_Union[TranslationTable, _Mapping]] = ..., trace_provenance: _Optional[_Union[TraceProvenance, _Mapping]] = ..., protovms: _Optional[_Union[TracePacket.ProtoVms, _Mapping]] = ..., module_symbols: _Optional[_Union[ModuleSymbols, _Mapping]] = ..., deobfuscation_mapping: _Optional[_Union[DeobfuscationMapping, _Mapping]] = ..., track_descriptor: _Optional[_Union[TrackDescriptor, _Mapping]] = ..., process_descriptor: _Optional[_Union[ProcessDescriptor, _Mapping]] = ..., thread_descriptor: _Optional[_Union[ThreadDescriptor, _Mapping]] = ..., ftrace_events: _Optional[_Union[FtraceEventBundle, _Mapping]] = ..., synchronization_marker: _Optional[bytes] = ..., compressed_packets: _Optional[bytes] = ..., extension_descriptor: _Optional[_Union[ExtensionDescriptor, _Mapping]] = ..., track_event_range_of_interest: _Optional[_Union[TrackEventRangeOfInterest, _Mapping]] = ..., etw_events: _Optional[_Union[EtwTraceEventBundle, _Mapping]] = ..., v8_js_code: _Optional[_Union[V8JsCode, _Mapping]] = ..., v8_internal_code: _Optional[_Union[V8InternalCode, _Mapping]] = ..., v8_wasm_code: _Optional[_Union[V8WasmCode, _Mapping]] = ..., v8_reg_exp_code: _Optional[_Union[V8RegExpCode, _Mapping]] = ..., v8_code_move: _Optional[_Union[V8CodeMove, _Mapping]] = ..., remote_clock_sync: _Optional[_Union[RemoteClockSync, _Mapping]] = ..., clone_snapshot_trigger: _Optional[_Union[Trigger, _Mapping]] = ..., generic_kernel_task_state_event: _Optional[_Union[GenericKernelTaskStateEvent, _Mapping]] = ..., generic_kernel_cpu_freq_event: _Optional[_Union[GenericKernelCpuFrequencyEvent, _Mapping]] = ..., generic_kernel_task_rename_event: _Optional[_Union[GenericKernelTaskRenameEvent, _Mapping]] = ..., generic_kernel_process_tree: _Optional[_Union[GenericKernelProcessTree, _Mapping]] = ..., evdev_event: _Optional[_Union[EvdevEvent, _Mapping]] = ..., for_testing: _Optional[_Union[TestEvent, _Mapping]] = ..., trusted_uid: _Optional[int] = ..., trusted_packet_sequence_id: _Optional[int] = ..., trusted_pid: _Optional[int] = ..., interned_data: _Optional[_Union[InternedData, _Mapping]] = ..., sequence_flags: _Optional[int] = ..., incremental_state_cleared: _Optional[bool] = ..., trace_packet_defaults: _Optional[_Union[TracePacketDefaults, _Mapping]] = ..., previous_packet_dropped: _Optional[bool] = ..., first_packet_on_sequence: _Optional[bool] = ..., machine_id: _Optional[int] = ...) -> None: ...
