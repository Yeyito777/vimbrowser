...
- UTC timestamp: 20260527T200840Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.764 | 1.764 | 1.764 | `0` |
| `cef_cc_backend_dev` | 1 | 16.902 | 16.902 | 16.902 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 16.416 | 16.416 | 16.416 | `0` |
| `cef_platform_config_backend_dev` | 1 | 16.475 | 16.475 | 16.475 | `0` |
| `cef_platform_accessibility_backend_dev` | 1 | 16.584 | 16.584 | 16.584 | `0` |
| `cef_platform_printing_backend_dev` | 1 | 20.239 | 20.239 | 20.239 | `0` |
| `shell_cc_build_source` | 1 | 8.410 | 8.410 | 8.410 | `0` |
