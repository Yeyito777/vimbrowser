...
- UTC timestamp: 20260527T220511Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.824 | 1.824 | 1.824 | `0` |
| `cef_cc_backend_dev` | 1 | 17.168 | 17.168 | 17.168 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 16.477 | 16.477 | 16.477 | `0` |
| `cef_platform_config_backend_dev` | 1 | 16.318 | 16.318 | 16.318 | `0` |
| `cef_platform_accessibility_backend_dev` | 1 | 16.337 | 16.337 | 16.337 | `0` |
| `cef_platform_printing_backend_dev` | 1 | 16.258 | 16.258 | 16.258 | `0` |
| `shell_cc_build_source` | 1 | 7.809 | 7.809 | 7.809 | `0` |
