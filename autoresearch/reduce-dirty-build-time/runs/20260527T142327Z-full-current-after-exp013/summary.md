...
- UTC timestamp: 20260527T142327Z
- Suite: full
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.748 | 1.748 | 1.748 | `0` |
| `cef_cc_backend_dev` | 1 | 35.439 | 35.439 | 35.439 | `0` |
| `shell_cc_build_source` | 1 | 8.646 | 8.646 | 8.646 | `0` |
| `blink_style_backend_dev` | 1 | 40.907 | 40.907 | 40.907 | `0` |
| `native_theme_backend_dev` | 1 | 23.598 | 23.598 | 23.598 | `0` |
