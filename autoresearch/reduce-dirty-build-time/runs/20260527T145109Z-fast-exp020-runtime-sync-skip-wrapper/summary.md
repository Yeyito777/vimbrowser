...
- UTC timestamp: 20260527T145109Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.741 | 1.741 | 1.741 | `0` |
| `cef_cc_backend_dev` | 1 | 34.236 | 34.236 | 34.236 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 22.703 | 22.703 | 22.703 | `0` |
