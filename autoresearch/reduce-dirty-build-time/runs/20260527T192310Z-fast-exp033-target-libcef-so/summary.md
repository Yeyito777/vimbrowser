...
- UTC timestamp: 20260527T192310Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 7.006 | 7.006 | 7.006 | `0` |
| `cef_cc_backend_dev` | 1 | 33.616 | 33.616 | 33.616 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 22.006 | 22.006 | 22.006 | `0` |
| `shell_cc_build_source` | 1 | 8.125 | 8.125 | 8.125 | `0` |
