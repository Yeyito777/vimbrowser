...
- UTC timestamp: 20260527T193457Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.769 | 1.769 | 1.769 | `0` |
| `cef_cc_backend_dev` | 1 | 16.760 | 16.760 | 16.760 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 22.058 | 22.058 | 22.058 | `0` |
| `shell_cc_build_source` | 1 | 8.478 | 8.478 | 8.478 | `0` |
