...
- UTC timestamp: 20260527T152259Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.711 | 1.711 | 1.711 | `0` |
| `cef_cc_backend_dev` | 1 | 33.470 | 33.470 | 33.470 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 21.233 | 21.233 | 21.233 | `0` |
| `shell_cc_build_source` | 1 | 8.377 | 8.377 | 8.377 | `0` |
