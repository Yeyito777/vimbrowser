...
- UTC timestamp: 20260527T193939Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.788 | 1.788 | 1.788 | `0` |
| `cef_cc_backend_dev` | 1 | 16.432 | 16.432 | 16.432 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 16.432 | 16.432 | 16.432 | `0` |
| `shell_cc_build_source` | 1 | 8.479 | 8.479 | 8.479 | `0` |
