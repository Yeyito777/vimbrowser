...
- UTC timestamp: 20260527T221546Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.801 | 1.801 | 1.801 | `0` |
| `cef_cc_backend_dev` | 1 | 16.708 | 16.708 | 16.708 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 16.258 | 16.258 | 16.258 | `0` |
| `cef_platform_config_backend_dev` | 1 | 16.104 | 16.104 | 16.104 | `0` |
| `cef_platform_accessibility_backend_dev` | 1 | 16.344 | 16.344 | 16.344 | `0` |
| `cef_platform_printing_backend_dev` | 1 | 16.271 | 16.271 | 16.271 | `0` |
| `shell_cc_build_source` | 1 | 8.215 | 8.215 | 8.215 | `0` |
