...
- UTC timestamp: 20260527T220732Z
- Suite: full
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.799 | 1.799 | 1.799 | `0` |
| `cef_cc_backend_dev` | 1 | 17.297 | 17.297 | 17.297 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 16.147 | 16.147 | 16.147 | `0` |
| `cef_platform_config_backend_dev` | 1 | 16.422 | 16.422 | 16.422 | `0` |
| `cef_platform_accessibility_backend_dev` | 1 | 16.383 | 16.383 | 16.383 | `0` |
| `cef_platform_printing_backend_dev` | 1 | 16.525 | 16.525 | 16.525 | `0` |
| `shell_cc_build_source` | 1 | 7.908 | 7.908 | 7.908 | `0` |
| `blink_style_backend_dev` | 1 | 40.721 | 40.721 | 40.721 | `0` |
| `native_theme_backend_dev` | 1 | 21.789 | 21.789 | 21.789 | `0` |
