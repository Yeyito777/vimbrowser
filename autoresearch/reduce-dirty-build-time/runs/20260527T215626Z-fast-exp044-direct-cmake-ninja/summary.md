...
- UTC timestamp: 20260527T215626Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.851 | 1.851 | 1.851 | `0` |
| `cef_cc_backend_dev` | 1 | 17.330 | 17.330 | 17.330 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 17.483 | 17.483 | 17.483 | `0` |
| `cef_platform_config_backend_dev` | 1 | 17.133 | 17.133 | 17.133 | `0` |
| `cef_platform_accessibility_backend_dev` | 1 | 17.452 | 17.452 | 17.452 | `0` |
| `cef_platform_printing_backend_dev` | 1 | 17.536 | 17.536 | 17.536 | `0` |
| `shell_cc_build_source` | 1 | 8.186 | 8.186 | 8.186 | `0` |
