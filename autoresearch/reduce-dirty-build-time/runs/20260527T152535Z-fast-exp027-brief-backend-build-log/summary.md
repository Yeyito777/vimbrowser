...
- UTC timestamp: 20260527T152535Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.676 | 1.676 | 1.676 | `0` |
| `cef_cc_backend_dev` | 1 | 33.052 | 33.052 | 33.052 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 21.902 | 21.902 | 21.902 | `0` |
| `shell_cc_build_source` | 1 | 8.026 | 8.026 | 8.026 | `0` |
