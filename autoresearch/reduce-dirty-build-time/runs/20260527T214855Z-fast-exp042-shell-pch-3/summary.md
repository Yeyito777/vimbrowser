...
- UTC timestamp: 20260527T214855Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.839 | 1.839 | 1.839 | `0` |
| `cef_cc_backend_dev` | 1 | 17.346 | 17.346 | 17.346 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 17.268 | 17.268 | 17.268 | `0` |
| `cef_platform_config_backend_dev` | 1 | 17.234 | 17.234 | 17.234 | `0` |
| `cef_platform_accessibility_backend_dev` | 1 | 17.297 | 17.297 | 17.297 | `0` |
| `cef_platform_printing_backend_dev` | 1 | 16.986 | 16.986 | 16.986 | `0` |
| `shell_cc_build_source` | 1 | 7.954 | 7.954 | 7.954 | `0` |
