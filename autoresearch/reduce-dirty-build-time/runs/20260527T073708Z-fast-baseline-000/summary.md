...
- UTC timestamp: 20260527T073708Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 17.782 | 17.782 | 17.782 | `0` |
| `cef_cc_backend_dev` | 1 | 67.735 | 67.735 | 67.735 | `0` |
| `shell_cc_build_source` | 1 | 13.347 | 13.347 | 13.347 | `0` |
