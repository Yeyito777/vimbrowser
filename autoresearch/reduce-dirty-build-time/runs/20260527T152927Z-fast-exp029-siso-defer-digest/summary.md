...
- UTC timestamp: 20260527T152927Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.702 | 1.702 | 1.702 | `0` |
| `cef_cc_backend_dev` | 1 | 33.315 | 33.315 | 33.315 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 21.845 | 21.845 | 21.845 | `0` |
| `shell_cc_build_source` | 1 | 8.075 | 8.075 | 8.075 | `0` |
