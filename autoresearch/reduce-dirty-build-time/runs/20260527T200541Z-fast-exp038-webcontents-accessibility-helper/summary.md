...
- UTC timestamp: 20260527T200541Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.789 | 1.789 | 1.789 | `0` |
| `cef_cc_backend_dev` | 1 | 16.571 | 16.571 | 16.571 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 16.754 | 16.754 | 16.754 | `0` |
| `cef_platform_config_backend_dev` | 1 | 16.602 | 16.602 | 16.602 | `0` |
| `cef_platform_accessibility_backend_dev` | 1 | 16.437 | 16.437 | 16.437 | `0` |
| `shell_cc_build_source` | 1 | 8.132 | 8.132 | 8.132 | `0` |
