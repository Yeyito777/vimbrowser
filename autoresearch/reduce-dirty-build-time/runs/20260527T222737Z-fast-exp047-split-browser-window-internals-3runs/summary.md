...
- UTC timestamp: 20260527T222737Z
- Suite: fast
- Runs per scenario: 3
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 3 | 1.984 | 1.971 | 1.985 | `0, 0, 0` |
| `cef_cc_backend_dev` | 3 | 17.837 | 17.636 | 18.547 | `0, 0, 0` |
| `vimbrowser_cef_api_backend_dev` | 3 | 17.654 | 17.634 | 17.868 | `0, 0, 0` |
| `cef_platform_config_backend_dev` | 3 | 17.670 | 17.514 | 17.717 | `0, 0, 0` |
| `cef_platform_accessibility_backend_dev` | 3 | 17.737 | 17.638 | 17.776 | `0, 0, 0` |
| `cef_platform_printing_backend_dev` | 3 | 17.811 | 17.627 | 17.958 | `0, 0, 0` |
| `shell_cc_build_source` | 3 | 7.483 | 7.441 | 7.693 | `0, 0, 0` |
