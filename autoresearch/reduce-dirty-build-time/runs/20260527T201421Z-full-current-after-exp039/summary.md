...
- UTC timestamp: 20260527T201421Z
- Suite: full
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.779 | 1.779 | 1.779 | `0` |
| `cef_cc_backend_dev` | 1 | 16.654 | 16.654 | 16.654 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 16.544 | 16.544 | 16.544 | `0` |
| `cef_platform_config_backend_dev` | 1 | 16.485 | 16.485 | 16.485 | `0` |
| `cef_platform_accessibility_backend_dev` | 1 | 16.410 | 16.410 | 16.410 | `0` |
| `cef_platform_printing_backend_dev` | 1 | 16.434 | 16.434 | 16.434 | `0` |
| `shell_cc_build_source` | 1 | 8.359 | 8.359 | 8.359 | `0` |
| `blink_style_backend_dev` | 1 | 38.533 | 38.533 | 38.533 | `0` |
| `native_theme_backend_dev` | 1 | 22.012 | 22.012 | 22.012 | `0` |
