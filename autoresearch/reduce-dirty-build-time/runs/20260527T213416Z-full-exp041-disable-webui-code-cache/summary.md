...
- UTC timestamp: 20260527T213416Z
- Suite: full
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 2.128 | 2.128 | 2.128 | `0` |
| `cef_cc_backend_dev` | 1 | 18.267 | 18.267 | 18.267 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 18.693 | 18.693 | 18.693 | `0` |
| `cef_platform_config_backend_dev` | 1 | 18.816 | 18.816 | 18.816 | `0` |
| `cef_platform_accessibility_backend_dev` | 1 | 18.569 | 18.569 | 18.569 | `0` |
| `cef_platform_printing_backend_dev` | 1 | 18.222 | 18.222 | 18.222 | `0` |
| `shell_cc_build_source` | 1 | 9.413 | 9.413 | 9.413 | `0` |
| `blink_style_backend_dev` | 1 | 41.341 | 41.341 | 41.341 | `0` |
| `native_theme_backend_dev` | 1 | 21.565 | 21.565 | 21.565 | `0` |
