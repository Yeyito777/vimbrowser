...
- UTC timestamp: 20260527T194257Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.903 | 1.903 | 1.903 | `0` |
| `cef_cc_backend_dev` | 1 | 16.505 | 16.505 | 16.505 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 16.315 | 16.315 | 16.315 | `0` |
| `shell_cc_build_source` | 1 | 8.268 | 8.268 | 8.268 | `0` |
