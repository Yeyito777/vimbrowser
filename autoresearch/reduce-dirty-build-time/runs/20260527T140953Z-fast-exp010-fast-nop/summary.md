...
- UTC timestamp: 20260527T140953Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 4.516 | 4.516 | 4.516 | `0` |
| `cef_cc_backend_dev` | 1 | 35.306 | 35.306 | 35.306 | `0` |
| `shell_cc_build_source` | 1 | 8.924 | 8.924 | 8.924 | `0` |
