...
- UTC timestamp: 20260527T151643Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.708 | 1.708 | 1.708 | `0` |
| `cef_cc_backend_dev` | 1 | 33.159 | 33.159 | 33.159 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 21.924 | 21.924 | 21.924 | `0` |
| `shell_cc_build_source` | 1 | 8.108 | 8.108 | 8.108 | `0` |
