...
- UTC timestamp: 20260527T145651Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.806 | 1.806 | 1.806 | `0` |
| `cef_cc_backend_dev` | 1 | 33.558 | 33.558 | 33.558 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 22.401 | 22.401 | 22.401 | `0` |
| `shell_cc_build_source` | 1 | 8.096 | 8.096 | 8.096 | `0` |
