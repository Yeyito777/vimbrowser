...
- UTC timestamp: 20260527T152741Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.713 | 1.713 | 1.713 | `0` |
| `cef_cc_backend_dev` | 1 | 33.088 | 33.088 | 33.088 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 21.847 | 21.847 | 21.847 | `0` |
| `shell_cc_build_source` | 1 | 8.232 | 8.232 | 8.232 | `0` |
