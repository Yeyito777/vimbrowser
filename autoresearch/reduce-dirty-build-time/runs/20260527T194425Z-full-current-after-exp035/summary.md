...
- UTC timestamp: 20260527T194425Z
- Suite: full
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.790 | 1.790 | 1.790 | `0` |
| `cef_cc_backend_dev` | 1 | 16.679 | 16.679 | 16.679 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 16.607 | 16.607 | 16.607 | `0` |
| `shell_cc_build_source` | 1 | 8.445 | 8.445 | 8.445 | `0` |
| `blink_style_backend_dev` | 1 | 38.593 | 38.593 | 38.593 | `0` |
| `native_theme_backend_dev` | 1 | 21.783 | 21.783 | 21.783 | `0` |
