...
- UTC timestamp: 20260527T215841Z
- Suite: full
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.804 | 1.804 | 1.804 | `0` |
| `cef_cc_backend_dev` | 1 | 17.578 | 17.578 | 17.578 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 17.199 | 17.199 | 17.199 | `0` |
| `cef_platform_config_backend_dev` | 1 | 17.670 | 17.670 | 17.670 | `0` |
| `cef_platform_accessibility_backend_dev` | 1 | 17.744 | 17.744 | 17.744 | `0` |
| `cef_platform_printing_backend_dev` | 1 | 17.526 | 17.526 | 17.526 | `0` |
| `shell_cc_build_source` | 1 | 8.240 | 8.240 | 8.240 | `0` |
| `blink_style_backend_dev` | 1 | 40.886 | 40.886 | 40.886 | `0` |
| `native_theme_backend_dev` | 1 | 22.610 | 22.610 | 22.610 | `0` |
