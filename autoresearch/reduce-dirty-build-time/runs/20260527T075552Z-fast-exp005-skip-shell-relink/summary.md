...
- UTC timestamp: 20260527T075552Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 7.312 | 7.312 | 7.312 | `0` |
| `cef_cc_backend_dev` | 1 | 34.589 | 34.589 | 34.589 | `0` |
| `shell_cc_build_source` | 1 | 8.233 | 8.233 | 8.233 | `0` |
