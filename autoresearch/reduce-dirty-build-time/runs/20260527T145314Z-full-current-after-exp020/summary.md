...
- UTC timestamp: 20260527T145314Z
- Suite: full
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.798 | 1.798 | 1.798 | `0` |
| `cef_cc_backend_dev` | 1 | 34.479 | 34.479 | 34.479 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 22.711 | 22.711 | 22.711 | `0` |
| `shell_cc_build_source` | 1 | 8.093 | 8.093 | 8.093 | `0` |
| `blink_style_backend_dev` | 1 | 39.350 | 39.350 | 39.350 | `0` |
| `native_theme_backend_dev` | 1 | 22.845 | 22.845 | 22.845 | `0` |
