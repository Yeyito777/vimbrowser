...
- UTC timestamp: 20260527T214520Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.865 | 1.865 | 1.865 | `0` |
| `cef_cc_backend_dev` | 1 | 18.316 | 18.316 | 18.316 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 18.042 | 18.042 | 18.042 | `0` |
| `cef_platform_config_backend_dev` | 1 | 17.606 | 17.606 | 17.606 | `0` |
| `cef_platform_accessibility_backend_dev` | 1 | 17.199 | 17.199 | 17.199 | `0` |
| `cef_platform_printing_backend_dev` | 1 | 17.219 | 17.219 | 17.219 | `0` |
| `shell_cc_build_source` | 1 | 7.984 | 7.984 | 7.984 | `0` |
