...
- UTC timestamp: 20260527T150247Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.716 | 1.716 | 1.716 | `0` |
| `cef_cc_backend_dev` | 1 | 33.312 | 33.312 | 33.312 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 21.556 | 21.556 | 21.556 | `0` |
| `shell_cc_build_source` | 1 | 8.344 | 8.344 | 8.344 | `0` |
