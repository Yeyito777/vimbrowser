...
- UTC timestamp: 20260527T075745Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 6.958 | 6.958 | 6.958 | `0` |
| `cef_cc_backend_dev` | 1 | 34.542 | 34.542 | 34.542 | `0` |
| `shell_cc_build_source` | 1 | 8.466 | 8.466 | 8.466 | `0` |
