...
- UTC timestamp: 20260527T200103Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.775 | 1.775 | 1.775 | `0` |
| `cef_cc_backend_dev` | 1 | 16.680 | 16.680 | 16.680 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 16.534 | 16.534 | 16.534 | `0` |
| `cef_platform_config_backend_dev` | 1 | 16.466 | 16.466 | 16.466 | `0` |
| `cef_platform_accessibility_backend_dev` | 1 | 30.214 | 30.214 | 30.214 | `0` |
| `shell_cc_build_source` | 1 | 8.149 | 8.149 | 8.149 | `0` |
