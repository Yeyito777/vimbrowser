...
- UTC timestamp: 20260527T220316Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.823 | 1.823 | 1.823 | `0` |
| `cef_cc_backend_dev` | 1 | 16.475 | 16.475 | 16.475 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 16.451 | 16.451 | 16.451 | `0` |
| `cef_platform_config_backend_dev` | 1 | 16.405 | 16.405 | 16.405 | `0` |
| `cef_platform_accessibility_backend_dev` | 1 | 16.419 | 16.419 | 16.419 | `0` |
| `cef_platform_printing_backend_dev` | 1 | 16.456 | 16.456 | 16.456 | `0` |
| `shell_cc_build_source` | 1 | 7.746 | 7.746 | 7.746 | `0` |
