...
- UTC timestamp: 20260527T192123Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.814 | 1.814 | 1.814 | `0` |
| `cef_cc_backend_dev` | 1 | 33.966 | 33.966 | 33.966 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 21.947 | 21.947 | 21.947 | `0` |
| `shell_cc_build_source` | 1 | 8.317 | 8.317 | 8.317 | `0` |
