...
- UTC timestamp: 20260527T153111Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.681 | 1.681 | 1.681 | `0` |
| `cef_cc_backend_dev` | 1 | 33.024 | 33.024 | 33.024 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 21.874 | 21.874 | 21.874 | `0` |
| `shell_cc_build_source` | 1 | 8.451 | 8.451 | 8.451 | `0` |
