...
- UTC timestamp: 20260527T143221Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 1.755 | 1.755 | 1.755 | `0` |
| `cef_cc_backend_dev` | 1 | 34.759 | 34.759 | 34.759 | `0` |
| `shell_cc_build_source` | 1 | 8.415 | 8.415 | 8.415 | `0` |
