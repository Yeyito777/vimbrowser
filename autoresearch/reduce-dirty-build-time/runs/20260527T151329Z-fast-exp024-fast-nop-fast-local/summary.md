...
- UTC timestamp: 20260527T151329Z
- Suite: fast
- Runs per scenario: 1
- Jobs: 12
...
| --- | ---: | ---: | ---: | ---: | --- |
| `noop_backend_dev` | 1 | 27.546 | 27.546 | 27.546 | `0` |
| `cef_cc_backend_dev` | 1 | 33.334 | 33.334 | 33.334 | `0` |
| `vimbrowser_cef_api_backend_dev` | 1 | 21.770 | 21.770 | 21.770 | `0` |
| `shell_cc_build_source` | 1 | 8.113 | 8.113 | 8.113 | `0` |
